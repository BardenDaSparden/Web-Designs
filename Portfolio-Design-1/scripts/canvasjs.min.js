...
(function() {
    ...
    function sa(a, c, b) {
        if (v && Na) {
            ...
            ta = d.webkitBackingStorePixelRatio || d.mozBackingStorePixelRatio || d.msBackingStorePixelRatio || d.oBackingStorePixelRatio || d.backingStorePixelRatio || 1;
            Q = Aa / ta;
            a.width = c * Q;
            a.height = b * Q;
            Aa !== ta && (a.style.width = c + "px", a.style.height = b + "px", d.scale(Q, Q))
    ...
    function Sa(a) {
        if (!Ba) {
            var c = !1,
                b = !1;
            "undefined" === typeof ba.Chart.creditHref ? (a.creditHref = "http://canvasjs.com/", a.creditText =
    ...
    function A(a, c) {
        ...
        if (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) {
            ...
            this.canvas.getContext && (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Qa(this.ctx), v ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = fa(d, f), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas),
                ...
                this._toolBar.style.cssText = "position: absolute; right: 1px; top: 1px;", this._canvasJSContainer.appendChild(this._toolBar), this.bounds = {
                    ...
                    b._mouseEventHandler(a);
                    Y(b._dropdownMenu)
                }), K(this.overlaidCanvas, "mouseout",
                    function(a) {
                        b._mouseEventHandler(a)
                ...
                this.toolTip = new S(this, this.options.toolTip), this.data = null, this.axisX = [], this.axisX2 = [], this.axisY = [], this.axisY2 = [], this.sessionVariables = {
                    axisX: [],
                    axisX2: [],
                    axisY: [],
                    axisY2: []
    ...
    function va(a, c) {
        for (var b = [], d, f = 0; f < a.length; f++)
            if (0 == f) b.push(a[0]);
                ...
                d = Math.abs((a[h].x - a[g].x) / (0 === a[h].x - a[k].x ? 0.01 : a[h].x - a[k].x)) * (c -
                    1) / 2 + 1;
                var l = (a[h].x - a[g].x) / d;
                d = (a[h].y - a[g].y) / d;
    ...
    function na(a, c) {
        na.base.constructor.call(this, "Title", c, a.theme, a);
        this.chart = a;
        this.canvas =
            a.canvas;
    ...
    function wa(a, c) {
        wa.base.constructor.call(this, "Subtitle", c, a.theme, a);
        this.chart = a;
    ...
    function xa(a, c) {
        xa.base.constructor.call(this, "Legend", c, a.theme, a);
        this.chart = a;
        this.canvas = a.canvas;
        this.ctx = this.chart.ctx;
    ...
    function B(a, c, b, d, f) {
        ...
        if (this.options.stripLines && 0 < this.options.stripLines.length)
            for (this.stripLines = [], c = 0; c < this.options.stripLines.length; c++) this.stripLines.push(new oa(this.chart, this.options.stripLines[c], a.theme, ++this.chart._eventManager.lastObjectId, this));
    ...
    function oa(a, c, b, d, f) {
        oa.base.constructor.call(this, "StripLine", c, b, f);
        this.id = d;
        this.chart = a;
        this.ctx = this.chart.ctx;
    ...
    function S(a, c) {
        S.base.constructor.call(this, "ToolTip", c, a.theme, a);
        this.chart = a;
        this.canvas = a.canvas;
        this.ctx = this.chart.ctx;
    ...
    function pa(a) {
        var c;
        a && qa[a] && (c = qa[a]);
        pa.base.constructor.call(this, "CultureInfo", c)
    }
    ...
    var z = {},
            ...
            for (var u = 0; k && u < k.length; u++)
                if (c = k[u], "." === c && 0 > l) l = u;
                    ...
                    if ("%" === c) h *= 100;
                        ...
                        l = u + c.length - 1;
                        continue
                    } else "E" !== c[0] && "e" !== c[0] || "0" !== c[c.length - 1] || (q = !0);
                    0 > l ? (m.push(c), "#" === c || "0" === c ? p++ : "," === c && r++) : (n.push(c), "#" !== c &&
                        "0" !== c || e++)
                }
            q && (c = Math.floor(a), k = -Math.floor(Math.log(a) / Math.LN10 + 1), s = 0 === a ? 0 : 0 === c ? -(p + k) : String(c).length - p, h /= Math.pow(10, s));
            0 > l && (l = u);
            h = (a * h).toFixed(e);
            c = h.split(".");
            h = (c[0] + "").split("");
                ...
                if (c = m.pop(), "#" === c || "0" === c)
                    if (l++, l === p) {
                        var w = h,
                            h = [];
                        if ("0" === c)
                            for (c = p - e - (w ? w.length : 0); 0 < c;) w.unshift("0"), c--;
                        for (; 0 < w.length;) b = w.pop() + b, q++, 0 === q % k && (u === r && 0 < w.length) && (b = g + b)
                    } else 0 < h.length ? (b = h.pop() + b, e++, q++) :
                        "0" === c && (b = "0" + b, e++, q++), 0 === q % k && (u === r && 0 < h.length) && (b = g + b);
            else "E" !== c[0] && "e" !== c[0] || "0" !== c[c.length - 1] || !/[eE][+-]*[0]+/.test(c) ? "," === c ? (u++, k = q, q = 0, 0 < h.length && (b = g + b)) : b = 1 < c.length && ('"' === c[0] && '"' === c[c.length - 1] || "'" === c[0] && "'" === c[c.length - 1]) ? c.slice(1, c.length - 1) + b : c + b : (c = 0 > s ? c.replace("+", "").replace("-", "") : c.replace("-", ""), b += c.replace(/[0]+/, function(a) {
                return O(s, a.length)
            }));
            g = "";
            for (m = !1; 0 < n.length;) c = n.shift(), "#" === c || "0" === c ? 0 < a.length && 0 !== Number(a.join("")) ? (g += a.shift(),
        ...
        ta = 1,
        Q = Na ? Aa / ta : 1,
        Ba = window && window.location && window.location.href && window.location.href.indexOf && (-1 !== window.location.href.indexOf("") || -1 !== window.location.href.indexOf("fenopix.com") || -1 !== window.location.href.indexOf("fiddle")),
        Ta = {
            reset: {
    ...
    (function() {
        ...
        z.fAWm = function(a) {
            ...
            //     var c = a[z.fSDec(z.str.ct)];
            //     c[z.fSDec(z.str.tBl)] = z.fSDec(z.str.tp);
            //     c[z.fSDec(z.str.fnt)] = 11 + z.fSDec(z.str.fntStr);
            //     c[z.fSDec(z.str.fSy)] = z.fSDec(z.str.gr);
            //     c[z.fSDec(z.str.fTx)](z.fSDec(z.str.tv), 2, a.height - 11 - 2)
            // }
        }
    })();
    (function() {
            ...
            if (!Ba) try {
                ...
                a: {
                    ...
                    if (f && 0 < f.length || g) {
                        ...
                        var n = Math.round(Math.abs(g - d.getTime())),
                            p;
                        if (!x(ka[z.ckDec(z.str.sk)]) && "string" === typeof ka[z.ckDec(z.str.sk)] && ka[z.ckDec(z.str.sk)]) {
                            var e = ka[z.ckDec(z.str.sk)],
                                d = [];
                            h = [];
                            for (var m = 0, b = f = "", r = e.substr(e.length - 3, e.length), k = 0; k < e.length - 3; k++) d.push(parseInt(e.charCodeAt(k)) - 59), f += String.fromCharCode(d[k]), m += parseInt(parseInt(f.charCodeAt(k)) + 59, 10);
                            m %= 256;
                            m = 99 < m ? "" + m : 9 < m ? "0" + m : "00" + m;
                            for (k = 0; k < r.length; k++) h.push(parseInt(r.charCodeAt(k)) - 59), b += String.fromCharCode(h[k]);
                            p = m === b ? f : 0
                        } else p = 0;
                        var q = p ? (new Date(Number(p))).getTime() - g : 5184E6;
                        if (isNaN(q) || n > q) {
                            c = !0;
                            break a
                        }
                ...
                if (c) {
                    ...
                    u.font = "bold " + c + (v ? "px Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif" : "px Lucida Sans Unicode");
                    var w = z.ckDec(z.str.tem),
                        y = u.measureText(w).width;
                    u.fillStyle = v ? z.ckDec(z.str.mco) : z.ckDec(z.str.mcw);
                    u.fillRect(a.plotArea.x2 - y - 8, a.plotArea.y2 - 2.5 * c - 8, y + 4, 2.5 * c +
                        8);
                    u.fillStyle = v ? z.ckDec(z.str.mct) : z.ckDec(z.str.mcr);
                    u.textBaseline = "top";
                    u.fillText(w, a.plotArea.x2 - y - 4, a.plotArea.y2 - 2.5 * c - 2);
                    c = 14;
                    u.font = c + (v ? "px Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif" : "px Lucida Sans Unicode");
                    w = z.ckDec(z.str.ctm);
                    y = u.measureText(w).width;
                    u.fillStyle = v ? z.ckDec(z.str.mct) : z.ckDec(z.str.mcr);
                    u.fillText(w, a.plotArea.x2 - y - 4, a.plotArea.y2 - 2 * c - 4);
                    w = z.ckDec(z.str.ltm);
                    y = u.measureText(w).width;
                    u.fillText(w, a.plotArea.x2 - y - 4, a.plotArea.y2 - c - 4)
                }
            } catch (t) {}
        }
    })();
    M.prototype.setOptions = function(a, c) {
    ...
    M.prototype.set = function(a, c, b) {
    ...
    M.prototype.addTo = function(a, c, b, d) {
        ...
        if ("undefined" !== typeof a || this.options._isPlaceholder)
            if (this.parent.options._isPlaceholder && this.parent.createUserOptions(), this.isOptionsInArray) {
                ...
                var c = this.parent.options[this.optionsName],
                    b = c.length;
                this.options._isPlaceholder || (ra(c), b = c.indexOf(this.options));
    ...
    M.prototype.addEventListener = function(a, c, b) {
        a && c && (this._eventListeners[a] = this._eventListeners[a] || [], this._eventListeners[a].push({
            context: b || this,
            eventHandler: c
        }))
    };
    M.prototype.removeEventListener = function(a, c) {
    ...
    M.prototype.dispatchEvent = function(a, c, b) {
    ...
    A.prototype._updateOptions = function() {
        ...
        this.options.zoomEnabled ? (this._zoomButton || (Y(this._zoomButton = document.createElement("button")), T(this, this._zoomButton, "pan"), this._toolBar.appendChild(this._zoomButton), K(this._zoomButton, "click", function() {
            a.zoomEnabled ? (a.zoomEnabled = !1, a.panEnabled = !0, T(a, a._zoomButton, "zoom")) : (a.zoomEnabled = !0, a.panEnabled = !1, T(a, a._zoomButton,
                "pan"));
            a.render()
        })), this._resetButton || (Y(this._resetButton = document.createElement("button")), T(this, this._resetButton, "reset"), this._toolBar.appendChild(this._resetButton), K(this._resetButton, "click", function() {
            a.toolTip.hide();
        ...
        }), this.overlaidCanvas.style.cursor = a._defaultCursor), this.zoomEnabled || this.panEnabled || (this._zoomButton ? (a._zoomButton.getAttribute("state") === a._cultureInfo.zoomText ? (this.panEnabled = !0, this.zoomEnabled = !1) : (this.zoomEnabled = !0, this.panEnabled = !1), ua(a._zoomButton, a._resetButton)) :
            (this.zoomEnabled = !0, this.panEnabled = !1))) : this.panEnabled = this.zoomEnabled = !1;
        this._menuButton ? this.exportEnabled ? ua(this._menuButton) : Y(this._menuButton) : this.exportEnabled && v && (this._menuButton = document.createElement("button"), T(this, this._menuButton, "menu"), this._toolBar.appendChild(this._menuButton), K(this._menuButton, "click", function() {
        ...
        if (!this._dropdownMenu && this.exportEnabled && v) {
            ...
            K(this._dropdownMenu, "blur", function() {
                Y(a._dropdownMenu);
            ...
            K(c, "mouseover", function() {
                this.style.backgroundColor = "#EEEEEE"
            }, !0);
            K(c, "mouseout", function() {
    ...
    A.prototype._updateSize = function() {
        ...
        return this.canvas.width !== a * Q || this.canvas.height !== c *
            Q ? (sa(this.canvas, a, c), sa(this.overlaidCanvas, a, c), sa(this._eventManager.ghostCanvas, a, c), !0) : !1
    };
    ...
    A.prototype.render = function(a) {
        ...
        for (a = 0; a < this.data.length; a++)
            if ("normal" ===
                ...
                if (!this.data[a].axisYType || "primary" === this.data[a].axisYType)
                    ...
                    } else this.axisY.length || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY[0] = new B(this, this.options.axisY, "axisY", "left", 0)) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY[0] = new B(this, this.options.axisY,
                ...
                if ("secondary" === this.data[a].axisYType)
                    if (this.options.axisY2 && 0 < this.options.axisY2.length) {
                        if (!this.axisY2.length)
                            for (b = 0; b < this.options.axisY2.length; b++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2[b] = new B(this, this.options.axisY2[b], "axisY", "right", b)) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY2[b] = new B(this, this.options.axisY2[b], "axisY", "top",
                                b));
                    ...
                    } else this.axisY2.length || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2[0] = new B(this, this.options.axisY2, "axisY", "right", 0)) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY2[0] = new B(this,
                ...
                if (!this.data[a].axisXType || "primary" === this.data[a].axisXType)
                    if (this.options.axisX && 0 < this.options.axisX.length) {
                        if (!this.axisX.length)
                            for (b = 0; b < this.options.axisX.length; b++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX[b] = new B(this, this.options.axisX[b], "axisX", "bottom", b)) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX[b] = new B(this,
                    ...
                    } else this.axisX.length || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX[0] = new B(this, this.options.axisX, "axisX", "bottom", 0)) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX[0] =
                        new B(this, this.options.axisX, "axisX", "left", 0))), this.data[a].axisX = this.axisX[0], this.axisX[0].dataSeries.push(this.data[a]);
                if ("secondary" === this.data[a].axisXType)
                    if (this.options.axisX2 && 0 < this.options.axisX2.length) {
                        if (!this.axisX2.length)
                            for (b = 0; b < this.options.axisX2.length; b++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX2[b] = new B(this, this.options.axisX2[b], "axisX", "top", b)) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX2[b] = new B(this, this.options.axisX2[b],
                                "axisX", "right", b));
                    ...
                    } else this.axisX2.length || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX2[0] = new B(this, this.options.axisX2, "axisX", "top", 0)) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX2[0] =
                        new B(this, this.options.axisX2, "axisX", "right", 0))), this.data[a].axisX = this.axisX2[0], this.axisX2[0].dataSeries.push(this.data[a])
            }
        if (this.axisY) {
        ...
        this._processData();
        this.options.title && (this.title = new na(this, this.options.title), this.title.dockInsidePlotArea ? c.push(this.title) : this.title.render());
        if (this.options.subtitles)
            for (this.subtitles = [], a = 0; a < this.options.subtitles.length; a++) b = new wa(this, this.options.subtitles[a]), this.subtitles.push(b), b.dockInsidePlotArea ? c.push(b) : b.render();
        ...
        if ("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) B.setLayoutAndRender(this.axisX,
        ...
        for (a = 0; a < this.plotInfo.plotTypes.length; a++)
            for (var c = this.plotInfo.plotTypes[a], g = 0; g < c.plotUnits.length; g++) {
                ...
                "line" === h.type ? k = this.renderLine(h) : "stepLine" === h.type ? k = this.renderStepLine(h) : "spline" === h.type ? k = this.renderSpline(h) : "column" === h.type ? k = this.renderColumn(h) : "bar" === h.type ? k = this.renderBar(h) : "area" === h.type ? k = this.renderArea(h) : "stepArea" === h.type ? k = this.renderStepArea(h) : "splineArea" === h.type ? k = this.renderSplineArea(h) : "stackedColumn" === h.type ? k = this.renderStackedColumn(h) :
                    ...
                    "rangeColumn" === h.type ? k = this.renderRangeColumn(h) : "rangeBar" === h.type ? k = this.renderRangeBar(h) : "rangeArea" === h.type ? k = this.renderRangeArea(h) : "rangeSplineArea" === h.type && (k = this.renderRangeSplineArea(h));
        ...
        0 < d.length ? (l.disableToolTip = !0, l._animator.animate(200, l.animationDuration, function(a) {
            ...
            for (var b = 0; b < d.length; b++) k = d[b], 1 > a && "undefined" !== typeof k.startTimePercent ? a >= k.startTimePercent && k.animationCallback(k.easingFunction(a - k.startTimePercent, 0, 1, 1 - k.startTimePercent), k) : k.animationCallback(k.easingFunction(a, 0, 1, 1), k);
    ...
    A.prototype.categoriseDataSeries = function() {
        for (var a = "", c = 0; c < this.data.length; c++)
            if (a = this.data[c], a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= A._supportedChartTypes.indexOf(a.type)) {
                for (var b = null, d = !1, f = null, g = !1, h =
                        0; h < this.plotInfo.plotTypes.length; h++)
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g = !1, h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                if ("normal" === k.axisPlacement || "xySwapped" === k.axisPlacement) var e = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : a.axisX.logarithmic ? 0 : -Infinity,
                    r = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ?
                ...
                for (l = 0; l < k.dataPoints.length; l++) {
                    ...
                    if (0 <
                        ...
                        if (a.axisX.logarithmic) {
                            var q = d / k.dataPoints[l - 1].x;
                            1 > q && (q = 1 / q);
                            b.minDiff > q && 1 !== q && (b.minDiff = q)
                        } else q = d - k.dataPoints[l - 1].x, 0 > q && (q *= -1), b.minDiff > q && 0 !== q && (b.minDiff = q);
                        null !== f && null !== k.dataPoints[l - 1].y && (a.axisY.logarithmic ? (q = f / k.dataPoints[l - 1].y, 1 > q && (q = 1 / q), c.minDiff > q && 1 !== q && (c.minDiff = q)) : (q = f - k.dataPoints[l - 1].y, 0 > q && (q *= -1), c.minDiff > q && 0 !== q && (c.minDiff = q)))
                    }
                    if (d < e && !m) null !== f && (p = d);
                    else {
                        if (!m && (m = !0, 0 < l)) {
                        ...
                        k.dataPoints[l].label &&
                            (a.axisX.labels[d] = k.dataPoints[l].label);
                        d < b.viewPortMin && (b.viewPortMin = d);
                        d > b.viewPortMax && (b.viewPortMax = d);
                        null === f ? b.viewPortMin === d && p < d && (b.viewPortMin = p) : (f < c.viewPortMin && (c.viewPortMin = f), f > c.viewPortMax && (c.viewPortMax = f))
                    }
                }
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g = !1, h = [], k = [], l = Infinity, m = 0; m < a.dataSeriesIndexes.length; m++) {
                ...
                for (p = 0; p < n.dataPoints.length; p++) {
                    ...
                    n.dataPoints[p].x.getTime ? (g = !0, d = n.dataPoints[p].x.getTime()) : d = n.dataPoints[p].x;
                    x(n.dataPoints[p].y) ? f = 0 : (f = n.dataPoints[p].y, 0 === m && (l = Math.min(f,
                        l)));
                    d < b.min && (b.min = d);
                    d > b.max && (b.max = d);
                    if (0 < p) {
                        if (a.axisX.logarithmic) {
                            var w = d / n.dataPoints[p - 1].x;
                            1 > w && (w = 1 / w);
                            b.minDiff > w && 1 !== w && (b.minDiff = w)
                        } else w = d - n.dataPoints[p - 1].x, 0 > w && (w *= -1), b.minDiff > w && 0 !== w && (b.minDiff = w);
                        null !== f && null !== n.dataPoints[p - 1].y && (a.axisY.logarithmic ? 0 < f && (w = f / n.dataPoints[p - 1].y, 1 > w && (w = 1 / w), c.minDiff > w && 1 !== w && (c.minDiff = w)) : (w = f - n.dataPoints[p - 1].y, 0 > w && (w *= -1), c.minDiff > w && 0 !== w && (c.minDiff = w)))
                    }
                    if (d < s && !e) null !== n.dataPoints[p].y && (q = d);
                    else {
                        if (!e && (e = !0, 0 < p)) {
                            p -=
                                2;
                        ...
                        n.dataPoints[p].label && (a.axisX.labels[d] = n.dataPoints[p].label);
                        d < b.viewPortMin && (b.viewPortMin = d);
                        d > b.viewPortMax && (b.viewPortMax = d);
                        null === n.dataPoints[p].y ? b.viewPortMin === d && q < d && (b.viewPortMin = q) : (a.yTotals[d] = (a.yTotals[d] ? a.yTotals[d] : 0) + Math.abs(f), 0 <= f ? h[d] = h[d] ? h[d] + f : f : k[d] = k[d] ? k[d] + f : f)
                    }
                }
                this.plotInfo.axisXValueType = n.xValueType = g ? "dateTime" : "number"
            }
            for (p in h) h.hasOwnProperty(p) && !isNaN(p) && (a = h[p], a < c.min && (c.min = Math.min(a, l)), a >
                c.max && (c.max = a), p < b.viewPortMin || p > b.viewPortMax || (a < c.viewPortMin && (c.viewPortMin = Math.min(a, l)), a > c.viewPortMax && (c.viewPortMax = a)));
            for (p in k) k.hasOwnProperty(p) && !isNaN(p) && (a = k[p], a < c.min && (c.min = Math.min(a, l)), a > c.max && (c.max = a), p < b.viewPortMin || p > b.viewPortMax || (a < c.viewPortMin && (c.viewPortMin = Math.min(a, l)), a > c.viewPortMax && (c.viewPortMax = a)))
        }
    };
    A.prototype._processStacked100PlotUnit = function(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo,
                    d, f, g = !1, h = !1, k = !1, l = [], m = 0; m < a.dataSeriesIndexes.length; m++) {
                ...
                for (p = 0; p < n.dataPoints.length; p++) {
                    ...
                    if (0 < p) {
                        ...
                        x(f) || null === n.dataPoints[p - 1].y || (a.axisY.logarithmic ? 0 < f && (w = f / n.dataPoints[p - 1].y, 1 > w && (w = 1 / w), c.minDiff > w && 1 !== w && (c.minDiff = w)) : (w = f - n.dataPoints[p - 1].y, 0 > w && (w *= -1), c.minDiff > w && 0 !== w && (c.minDiff = w)))
                    }
                    if (d < s && !e) null !== f && (q = d);
                    else {
                        if (!e && (e = !0, 0 < p)) {
                        ...
                        d < b.viewPortMin && (b.viewPortMin = d);
                        d > b.viewPortMax && (b.viewPortMax = d);
                        null === f ? b.viewPortMin === d && q < d && (b.viewPortMin = q) : (a.yTotals[d] = (a.yTotals[d] ? a.yTotals[d] : 0) + Math.abs(f), 0 <= f ? h = !0 : 0 > f && (k = !0), l[d] = l[d] ? l[d] + Math.abs(f) : Math.abs(f))
                    }
                }
                this.plotInfo.axisXValueType = n.xValueType = g ? "dateTime" : "number"
            }
            a.axisY.logarithmic ? (c.max = x(c.viewPortMax) ? 99 * Math.pow(a.axisY.logarithmBase, -0.05) : Math.max(c.viewPortMax, 99 * Math.pow(a.axisY.logarithmBase, -0.05)), c.min = x(c.viewPortMin) ? 1 : Math.min(c.viewPortMin, 1)) : h && !k ? (c.max = x(c.viewPortMax) ? 99 : Math.max(c.viewPortMax, 99), c.min = x(c.viewPortMin) ? 1 : Math.min(c.viewPortMin, 1)) : h && k ? (c.max = x(c.viewPortMax) ? 99 : Math.max(c.viewPortMax, 99), c.min = x(c.viewPortMin) ? -99 : Math.min(c.viewPortMin, -99)) : !h && k && (c.max = x(c.viewPortMax) ? -1 : Math.max(c.viewPortMax, -1), c.min = x(c.viewPortMin) ? -99 : Math.min(c.viewPortMin, -99));
            c.viewPortMin = c.min;
            c.viewPortMax =
                c.max;
            a.dataPointYSums = l
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g, h, k = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                var m = this.data[a.dataSeriesIndexes[l]],
                    ...
                    e = !1,
                    r, q, s;
                if ("normal" === m.axisPlacement || "xySwapped" === m.axisPlacement) var u = this.sessionVariables.axisX.newViewportMinimum ? this.sessionVariables.axisX.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ?
                ...
                for (n = 0; n < m.dataPoints.length; n++) {
                    "undefined" ===
                    typeof m.dataPoints[n].x && (m.dataPoints[n].x = n + (a.axisX.logarithmic ? 1 : 0));
                    m.dataPoints[n].x.getTime ? (k = !0, d = m.dataPoints[n].x.getTime()) : d = m.dataPoints[n].x;
                    ...
                    g < c.min && (c.min = g);
                    h > c.max && (c.max = h);
                    0 < n && (a.axisX.logarithmic ? (q = d / m.dataPoints[n - 1].x, 1 > q && (q = 1 / q), b.minDiff > q && 1 !== q && (b.minDiff = q)) : (q = d - m.dataPoints[n -
                        1].x, 0 > q && (q *= -1), b.minDiff > q && 0 !== q && (b.minDiff = q)), f && (null !== f[0] && m.dataPoints[n - 1].y && null !== m.dataPoints[n - 1].y[0]) && (a.axisY.logarithmic ? (q = f[0] / m.dataPoints[n - 1].y[0], 1 > q && (q = 1 / q), c.minDiff > q && 1 !== q && (c.minDiff = q)) : (q = f[0] - m.dataPoints[n - 1].y[0], 0 > q && (q *= -1), c.minDiff > q && 0 !== q && (c.minDiff = q))));
                    if (!(d < u) || p) {
                        if (!p && (p = !0, 0 < n)) {
                            n -= 2;
                            r = s;
                        ...
                        if (d > w && !e) e = !0;
                        else if (d > w && e) continue;
                        m.dataPoints[n].label && (a.axisX.labels[d] = m.dataPoints[n].label);
                        d < b.viewPortMin && (b.viewPortMin = d);
                        d > b.viewPortMax &&
                            (b.viewPortMax = d);
                        ...
                        null === f ? b.viewPortMin === d && r < d && (b.viewPortMin = r) : (g < c.viewPortMin && (c.viewPortMin = g), h > c.viewPortMax && (c.viewPortMax = h))
                    }
                }
    ...
    A.prototype.getDataPointAtXY = function(a, c, b) {
        ...
        for (b = 0; b < d.length; b++)
            if ("line" === d[b].dataSeries.type || "stepLine" === d[b].dataSeries.type || "area" === d[b].dataSeries.type || "stepArea" === d[b].dataSeries.type)
                if (f = L("markerSize", d[b].dataPoint, d[b].dataSeries) || 8, d[b].distance <= f / 2) {
                    c = !0;
                    break
                }
    ...
    A.prototype.getObjectAtXY = function(a, c, b) {
        ...
        else if (v) d = Ma(a, c, this._eventManager.ghostCtx);
        else
        ...
        if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
            ...
            if (this.panEnabled || this.zoomEnabled) {
                if (this.panEnabled)
                    ...
                    2 < Math.abs(b - f) && 2 < Math.abs(d - g) && this._zoomPanToSelectedRegion(b, d, f, g) && (h = !0)
                }
                h && (this._ignoreNextEvent = !0, this._dispatchRangeEvent("rangeChanging", "zoom"), this.render(), this._dispatchRangeEvent("rangeChanged", "zoom"), h && (this.zoomEnabled && "none" === this._zoomButton.style.display) && (ua(this._zoomButton, this._resetButton), T(this, this._zoomButton, "pan"), T(this, this._resetButton,
                    "reset")))
            }
        }
        this.isDrag = !1
        ...
        if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
            ...
            if ((!f || 2 < Math.abs(b) ||
                ...
                if (this.panEnabled) f = {
                    ...
                    return function() {
                        h._zoomPanToSelectedRegion(b, d, e, f, !0) && (h._dispatchRangeEvent("rangeChanging", "pan"), h.render(), h._dispatchRangeEvent("rangeChanged", "pan"), h.dragStartPoint.x = a, h.dragStartPoint.y =
                            c)
                    }
                ...
                this.overlaidCanvasCtx.fillRect(d, k, l, m);
    ...
    A.prototype.validateRegion = function(a, c, b, d,
        f) {
        f = f || !1;
        for (var g = 0 <= this.zoomType.indexOf("x"), h = 0 <= this.zoomType.indexOf("y"), k = !1, l = [], m = [], n = [], p = 0; p < this.axisX.length; p++) this.axisX[p] && g && m.push(this.axisX[p]);
        ...
        for (g = 0; g < m.length; g++) {
            ...
            if (isFinite(h.dataInfo.minDiff))
                if (!(h.logarithmic && e / p < Math.pow(h.dataInfo.minDiff, 3) || !h.logarithmic && Math.abs(e - p) < 3 * Math.abs(h.dataInfo.minDiff) || p < h.minimum || e > h.maximum)) l.push(h), n.push({
                    val1: p,
                    val2: e
                }), k = !0;
                else if (!f) {
        ...
        function(a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                ...
                var h = L("indexLabelFontWeight", m.dataPoint, m.dataSeries),
                    ...
                    s = L("indexLabelLineColor", m.dataPoint, m.dataSeries),
                    ...
                    d = 0 < u ? Math.min(10, ("normal" === this.plotInfo.axisPlacement ? this.plotArea.height : this.plotArea.width) << 0) : 0,
                    w = {
                        percent: null,
                        total: null
                    },
                ...
                var t = m.dataPoint.indexLabelFormatter ? m.dataPoint.indexLabelFormatter(y) : m.dataPoint.indexLabel ? this.replaceKeywordsWithValue(m.dataPoint.indexLabel, m.dataPoint,
                ...
                if (null !== t && "" !== t) {
                    ...
                    r.measureText();
                    m.dataSeries.indexLabelMaxWidth = r.maxWidth;
                    if (0 <= n.indexOf("line") || 0 <= n.indexOf("area") || 0 <= n.indexOf("bubble") || 0 <= n.indexOf("scatter")) {
                        ...
                        if (m.dataPoint.x < Z.viewportMinimum ||
                            m.dataPoint.x > Z.viewportMaximum || m.bounds.y1 > b.y2 || m.bounds.y2 < b.y1) continue
                    ...
                    if ("normal" === this.plotInfo.axisPlacement) {
                        ...
                        else if (0 <= n.indexOf("stacked")) "auto" ===
                            w && (w = "inside");
                        else if ("bubble" === n || "scatter" === n) w = "inside";
                        p = m.point.x - k / 2;
                        "inside" !== w ? (f = b.y1, g = b.y2, 0 < D ? (e = m.point.y - l - h - d, e < f && (e = "auto" === w ? Math.max(m.point.y, f) + h + d : f + h + d, z = e + l > m.point.y)) : (e = m.point.y + h + d, e > g - l - h - d && (e = "auto" === w ? Math.min(m.point.y, g) - l - h - d : g - l - h - d, z = e < m.point.y))) : (f = Math.max(m.bounds.y1, b.y1), g = Math.min(m.bounds.y2, b.y2), d = 0 <= n.indexOf("range") ? 0 < D ? Math.max(m.bounds.y1, b.y1) + l / 2 + h : Math.min(m.bounds.y2, b.y2) - l / 2 - h : (Math.max(m.bounds.y1, b.y1) + Math.min(m.bounds.y2, b.y2)) /
                            2, 0 < D ? (e = Math.max(m.point.y, d) - l / 2, e < f && ("bubble" === n || "scatter" === n) && (e = Math.max(m.point.y - l - h, b.y1 + h))) : (e = Math.min(m.point.y, d) - l / 2, e > g - l - h && ("bubble" === n || "scatter" === n) && (e = Math.min(m.point.y + h, b.y2 - l - h))), e = Math.min(e, g - l))
                    } else 0 <= n.indexOf("line") || 0 <= n.indexOf("area") || 0 <= n.indexOf("scatter") ? (w = "auto", f = 4) : 0 <= n.indexOf("stacked") ? "auto" === w && (w = "inside") : "bubble" === n && (w = "inside"), e = m.point.y - l / 2, "inside" !== w ? (h = b.x1, g = b.x2, 0 > D ? (p = m.point.x - k - f - d, p < h && (p = "auto" === w ? Math.max(m.point.x, h) +
                        f + d : h + f + d, z = p + k > m.point.x)) : (p = m.point.x + f + d, p > g - k - f - d && (p = "auto" === w ? Math.min(m.point.x, g) - k - f - d : g - k - f - d, z = p < m.point.x))) : (h = Math.max(m.bounds.x1, b.x1), Math.min(m.bounds.x2, b.x2), d = 0 <= n.indexOf("range") ? 0 > D ? Math.max(m.bounds.x1, b.x1) + k / 2 + f : Math.min(m.bounds.x2, b.x2) - k / 2 - f : (Math.max(m.bounds.x1, b.x1) + Math.min(m.bounds.x2, b.x2)) / 2, p = 0 > D ? Math.max(m.point.x, d) - k / 2 : Math.min(m.point.x, d) - k / 2, p = Math.max(p, h));
                    "vertical" === y && (e += l);
                    r.x = p;
                    r.y = e;
                    r.render(!0);
                    u && ("inside" !== w && (0 > n.indexOf("bar") && m.point.x >
                        b.x1 && m.point.x < b.x2 || !z) && (0 > n.indexOf("column") && m.point.y > b.y1 && m.point.y < b.y2 || !z)) && (c.lineWidth = u, c.strokeStyle = s ? s : "gray", c.setLineDash && c.setLineDash(I(q, u)), c.beginPath(), c.moveTo(m.point.x, m.point.y), 0 <= n.indexOf("bar") ? c.lineTo(p + (0 < m.direction ? 0 : k), e + ("horizontal" === y ? l : -l) / 2) : 0 <= n.indexOf("column") ? c.lineTo(p + k / 2, e + ((0 < m.direction ? l : -l) + ("horizontal" === y ? l : -l)) / 2) : c.lineTo(p + k / 2, e + ((e < m.point.y ? l : -l) + ("horizontal" === y ? l : -l)) / 2), c.stroke())
                }
            }
            c = {
                source: c,
            ...
            for (a = 0; a < this._indexLabels.length; a++) m = this._indexLabels[a], r = L("indexLabelBackgroundColor", m.dataPoint, m.dataSeries), m.dataSeries.indexLabelBackgroundColor = x(r) ? v ? "transparent" : null : r;
            return c
        };
    A.prototype.renderLine = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            c.clip();
            for (var d = [], f = null, g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                var e = k._colorSet,
                    r = e = k.lineColor = k.options.lineColor ?
                ...
                if (0 < l.length) {
                    for (var y = !1, s = 0; s < l.length; s++)
                        if (u = l[s].x.getTime ? l[s].x.getTime() : l[s].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !y)))
                            if ("number" !== typeof l[s].y) 0 < s && !(k.connectNullData || y || q) && (c.stroke(), v && b.stroke()), y = !0;
                            else {
                                ...
                                q || y ? (!q && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || m === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), m = k.nullDataLineDashType, c.setLineDash(n)), c.lineTo(u, w), v && b.lineTo(u, w)) : (c.beginPath(), c.moveTo(u, w), v && (b.beginPath(), b.moveTo(u, w))), y = q = !1) : (c.lineTo(u, w), v && b.lineTo(u, w), 0 == s % 500 && (c.stroke(), c.beginPath(), c.moveTo(u, w), v && (b.stroke(), b.beginPath(), b.moveTo(u, w))));
                                s < l.length - 1 && (r !== (l[s].lineColor ||
                                    e) || m !== (l[s].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(u, w), r = l[s].lineColor || e, c.strokeStyle = r, c.setLineDash && (l[s].lineDashType ? (m = l[s].lineDashType, c.setLineDash(I(m, k.lineThickness))) : (m = k.lineDashType, c.setLineDash(p))));
                                if (0 < l[s].markerSize || 0 < k.markerSize) {
                                    var D = k.getMarkerProperties(s, u, w, c),
                                        f = D.color;
                                    d.push(D);
                                    t = G(t);
                                    v && d.push({
                                ...
                                }(l[s].indexLabel || k.indexLabel || l[s].indexLabelFormatter ||
                    ...
                    for (var y = !1, s = 0; s < l.length; s++)
                        if (u = l[s].getTime ? l[s].x.getTime() : l[s].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !y)))
                            if ("number" !== typeof l[s].y) 0 < s && !(k.connectNullData || y || q) && (c.stroke(), v && b.stroke()), y = !0;
                                ...
                                q || y ? (!q && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || m === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), m = k.nullDataLineDashType, c.setLineDash(n)), c.lineTo(u, t), c.lineTo(u, w), v && (b.lineTo(u, t), b.lineTo(u, w))) : (c.beginPath(), c.moveTo(u, w), v && (b.beginPath(), b.moveTo(u, w))), y = q = !1) : (c.lineTo(u,
                                    t), v && b.lineTo(u, t), c.lineTo(u, w), v && b.lineTo(u, w), 0 == s % 500 && (c.stroke(), c.beginPath(), c.moveTo(u, w), v && (b.stroke(), b.beginPath(), b.moveTo(u, w))));
                                s < l.length - 1 && (r !== (l[s].lineColor || e) || m !== (l[s].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(u, w), r = l[s].lineColor || e, c.strokeStyle = r, c.setLineDash && (l[s].lineDashType ? (m = l[s].lineDashType, c.setLineDash(I(m, k.lineThickness))) : (m = k.lineDashType, c.setLineDash(p))));
                                if (0 < l[s].markerSize || 0 < k.markerSize) t = k.getMarkerProperties(s, u, w,
                                    c), f = t.color, d.push(t), D = G(D), v && d.push({
                                    x: u,
                                    y: w,
                                    ctx: b,
                                    type: t.type,
        ...
        function c(a) {
            ...
            if (0 < a.length) {
                ...
                for (var c = 0; c < a.length - 3; c += 3)
                    if (b.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y), v && d.bezierCurveTo(a[c + 1].x, a[c + 1].y,
                            a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y), 0 < c && 0 === c % 3E3 || a[c + 3].newStrokeStyle || a[c + 3].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(a[c + 3].x, a[c + 3].y), a[c + 3].newStrokeStyle && (b.strokeStyle = a[c + 3].newStrokeStyle), a[c + 3].newLineDashArray && b.setLineDash(a[c + 3].newLineDashArray), v && (d.stroke(), d.beginPath(), d.moveTo(a[c + 3].x, a[c + 3].y));
                b.stroke();
                v && d.stroke()
            }
        }
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var f = [], g = null, h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                var m = l.dataPoints,
                    n = "solid";
                if (b.setLineDash) {
                    var p = I(l.nullDataLineDashType, l.lineThickness),
                        n = l.lineDashType,
                ...
                r = G(r);
                d.strokeStyle = r;
                d.lineWidth = 0 < l.lineThickness ? Math.max(l.lineThickness,
                    4) : 0;
                var r = l._colorSet,
                ...
                if (0 < m.length)
                    for (w = !1, s = 0; s < m.length; s++)
                        if (u = m[s].getTime ? m[s].x.getTime() : m[s].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!l.connectNullData || !w)))
                            if ("number" !== typeof m[s].y) 0 < s && !w && (l.connectNullData ? b.setLineDash && (0 < y.length && (l.options.nullDataLineDashType || !m[s - 1].lineDashType)) && (y[y.length - 1].newLineDashArray = p, n = l.nullDataLineDashType) :
                                (c(y), y = [])), w = !0;
                            else {
                                u = a.axisX.convertValueToPixel(u);
                                ...
                                s < m.length - 1 && (q !== (m[s].lineColor || r) || n !== (m[s].lineDashType || l.lineDashType)) && (q = m[s].lineColor || r, y[y.length - 1].newStrokeStyle = q, b.setLineDash && (m[s].lineDashType ? (n = m[s].lineDashType, y[y.length - 1].newLineDashArray = I(n, l.lineThickness)) : (n = l.lineDashType,
                                ...
                                }(m[s].indexLabel || l.indexLabel || m[s].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "spline",
                                    dataPoint: m[s],
                                    dataSeries: l,
                                    point: {
    ...
    var N = function(a, c, b, d, f, g, h, k, l, m, n, p, e) {
        "undefined" === typeof e && (e = 1);
        h = h || 0;
        k = k || "black";
        var r = 15 < d - c && 15 < f - b ? 8 : 0.35 * Math.min(d - c, f - b);
        a.beginPath();
        a.moveTo(c, b);
        a.save();
        a.fillStyle = g;
        ...
        a.globalAlpha = 1;
        0 < h && (e = 0 === h % 2 ? 0 : 0.5, a.beginPath(), a.lineWidth = h, a.strokeStyle = k, a.moveTo(c, b), a.rect(c -
            e, b - e, d - c + 2 * e, f - b + 2 * e), a.stroke());
        a.restore();
        !0 === l && (a.save(), a.beginPath(), a.moveTo(c, b), a.lineTo(c + r, b + r), a.lineTo(d - r, b + r), a.lineTo(d, b), a.closePath(), h = a.createLinearGradient((d + c) / 2, b + r, (d + c) / 2, b), h.addColorStop(0, g), h.addColorStop(1, "rgba(255, 255, 255, .4)"), a.fillStyle = h, a.fill(), a.restore());
        !0 === m && (a.save(), a.beginPath(), a.moveTo(c, f), a.lineTo(c + r, f - r), a.lineTo(d - r, f - r), a.lineTo(d, f), a.closePath(), h = a.createLinearGradient((d + c) / 2, f - r, (d + c) / 2, f), h.addColorStop(0, g), h.addColorStop(1, "rgba(255, 255, 255, .4)"),
            a.fillStyle = h, a.fill(), a.restore());
        !0 === n && (a.save(), a.beginPath(), a.moveTo(c, b), a.lineTo(c + r, b + r), a.lineTo(c + r, f - r), a.lineTo(c, f), a.closePath(), h = a.createLinearGradient(c + r, (f + b) / 2, c, (f + b) / 2), h.addColorStop(0, g), h.addColorStop(1, "rgba(255, 255, 255, 0.1)"), a.fillStyle = h, a.fill(), a.restore());
        !0 === p && (a.save(), a.beginPath(), a.moveTo(d, b), a.lineTo(d - r, b + r), a.lineTo(d - r, f - r), a.lineTo(d, f), h = a.createLinearGradient(d - r, (f + b) / 2, d, (f + b) / 2), h.addColorStop(0, g), h.addColorStop(1, "rgba(255, 255, 255, 0.1)"),
            a.fillStyle = h, h.addColorStop(0, g), h.addColorStop(1, "rgba(255, 255, 255, 0.1)"), a.fillStyle = h, a.fill(), a.closePath(), a.restore())
    };
    A.prototype.renderColumn = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null,
                ...
                this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.width, 0.9 * (this.plotArea.width / a.plotType.totalDataSeries)) << 0,
                n = a.axisX.dataInfo.minDiff;
            isFinite(n) || (n = 0.3 * Math.abs(a.axisX.range));
            n = this.dataPointWidth = this.dataPointWidth ? this.dataPointWidth : 0.9 * (d.width * (a.axisX.logarithmic ? Math.log(n) / Math.log(a.axisX.range) : Math.abs(n) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0;
            this.dataPointMaxWidth && f > m && (f = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity,
                m));
            ...
            for (d = 0; d < a.dataSeriesIndexes.length; d++) {
                ...
                if (0 < e.length)
                    for (var r =
                            5 < n && p.bevelEnabled ? !0 : !1, f = 0; f < e.length; f++)
                        if (e[f].getTime ? k = e[f].x.getTime() : k = e[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && "number" === typeof e[f].y) {
                            ...
                            g = a.axisX.reversed ? g + a.plotType.totalDataSeries * n / 2 - (a.previousDataSeriesCount + d) * n << 0 : g - a.plotType.totalDataSeries * n / 2 + (a.previousDataSeriesCount + d) * n << 0;
                            var q = a.axisX.reversed ? g - n << 0 : g + n << 0,
                                s;
                            0 <= e[f].y ? s = l : (s = h, h = l);
                            h > s && (b = h, h = s, s = b);
                            b = e[f].color ?
                                e[f].color : p._colorSet[f % p._colorSet.length];
                            N(c, g, h, q, s, b, 0, null, r && 0 <= e[f].y, 0 > e[f].y && r, !1, !1, p.fillOpacity);
                            b = p.dataPointIds[f];
    ...
    A.prototype.renderStackedColumn = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            p = this.dataPointWidth ? this.dataPointWidth : 0.9 * (d.width * (a.axisX.logarithmic ? Math.log(p) / Math.log(a.axisX.range) : Math.abs(p) / Math.abs(a.axisX.range)) /
                    ...
                    for (k = 0; k < q.length; k++)
                        if (b = q[k].x.getTime ? q[k].x.getTime() : q[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[k].y) {
                            var d = a.axisX.convertValueToPixel(b),
                                u = d - a.plotType.plotUnits.length * p / 2 + a.index * p << 0,
                                w = u + p << 0,
                                y;
                            ...
                            N(c, u, l, w, y, b, 0, null, s && 0 <= q[k].y, 0 > q[k].y && s, !1, !1, r.fillOpacity);
                            b = r.dataPointIds[k];
                            this._eventManager.objectMap[b] = {
                                id: b,
                                objectType: "dataPoint",
    ...
    A.prototype.renderStackedColumn100 =
        function(a) {
            var c = a.targetCanvasCtx || this.plotArea.ctx;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                ...
                p = this.dataPointWidth ?
                    this.dataPointWidth : 0.9 * (d.width * (a.axisX.logarithmic ? Math.log(p) / Math.log(a.axisX.range) : Math.abs(p) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0;
                this.dataPointMaxWidth && k > n && (k = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, n));
                !this.dataPointMaxWidth && (this.dataPointMinWidth && n < k) && (n = Math.max(this.dataPointWidth ? this.dataPointWidth : -Infinity, k));
                p < k && (p = k);
                p > n && (p = n);
                    ...
                    if (0 < q.length)
                        for (var s = 5 < p && r.bevelEnabled ? !0 : !1, k = 0; k < q.length; k++)
                            if (b = q[k].x.getTime ? q[k].x.getTime() : q[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[k].y) {
                                ...
                                l = 0 !== a.dataPointYSums[b] ?
                                    100 * (q[k].y / a.dataPointYSums[b]) : 0;
                                var u = d - a.plotType.plotUnits.length * p / 2 + a.index * p << 0,
                                    w = u + p << 0,
                                    y;
    ...
    A.prototype.renderBar = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null,
                ...
                n = a.axisX.dataInfo.minDiff;
            isFinite(n) || (n = 0.3 * Math.abs(a.axisX.range));
            n = this.dataPointWidth ? this.dataPointWidth : 0.9 * (d.height * (a.axisX.logarithmic ? Math.log(n) / Math.log(a.axisX.range) : Math.abs(n) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0;
            this.dataPointMaxWidth && f > m && (f = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, m));
            !this.dataPointMaxWidth &&
                (this.dataPointMinWidth && m < f) && (m = Math.max(this.dataPointWidth ? this.dataPointWidth : -Infinity, f));
            n < f && (n = f);
            n > m && (n = m);
            c.save();
            v && this._eventManager.ghostCtx.save();
                ...
                if (0 < e.length) {
                    ...
                    for (f = 0; f < e.length; f++)
                        if (e[f].getTime ? k = e[f].x.getTime() : k = e[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && "number" === typeof e[f].y) {
                            ...
                            h = a.axisX.reversed ? h + a.plotType.totalDataSeries * n / 2 - (a.previousDataSeriesCount + d) * n << 0 : h - a.plotType.totalDataSeries * n / 2 + (a.previousDataSeriesCount + d) * n << 0;
                            var q = a.axisX.reversed ? h - n << 0 : h + n << 0,
                                s;
                            0 <= e[f].y ? s = l : (s = g, g = l);
                            b = e[f].color ? e[f].color :
                                p._colorSet[f % p._colorSet.length];
                            N(c, s, h, g, q, b, 0, null, r, !1, !1, !1, p.fillOpacity);
                            b = p.dataPointIds[f];
                            this._eventManager.objectMap[b] = {
                                id: b,
                                objectType: "dataPoint",
                            ...
                            (e[f].indexLabel || p.indexLabel || e[f].indexLabelFormatter || p.indexLabelFormatter) && this._indexLabels.push({
                                ...
                                direction: 0 > e[f].y === a.axisY.reversed ?
                                    1 : -1,
                                bounds: {
                                    x1: Math.min(s, g),
                                    y1: h,
    ...
    A.prototype.renderStackedBar = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null,
                ...
                p = a.axisX.dataInfo.minDiff;
            isFinite(p) || (p = 0.3 * Math.abs(a.axisX.range));
            p = this.dataPointWidth ? this.dataPointWidth : 0.9 * (d.height * (a.axisX.logarithmic ? Math.log(p) / Math.log(a.axisX.range) : Math.abs(p) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0;
            this.dataPointMaxWidth &&
                    ...
                    for (k = 0; k < q.length; k++)
                        if (b = q[k].x.getTime ? q[k].x.getTime() : q[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[k].y) {
                            ...
                            if (a.axisY.logarithmic) h[b] = q[k].y + (h[b] ? h[b] : 0), 0 < h[b] && (y = f[b] ? f[b] : m, f[b] = l = a.axisY.convertValueToPixel(h[b]));
                                ...
                                a.axisY.convertValueToPixel(q[k].y), 0 <= q[k].y) {
                                var t = f[b] ? f[b] : 0;
                                y = m + t;
                                l += t;
                                f[b] = t + (l - y)
                            ...
                            b = q[k].color ? q[k].color : r._colorSet[k % r._colorSet.length];
                            N(c, y, u, l, w, b, 0, null, s, !1, !1, !1, r.fillOpacity);
                            b = r.dataPointIds[k];
                            this._eventManager.objectMap[b] = {
                                id: b,
                                objectType: "dataPoint",
                            ...
                            (q[k].indexLabel || r.indexLabel || q[k].indexLabelFormatter ||
    ...
    A.prototype.renderStackedBar100 = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            p = this.dataPointWidth ? this.dataPointWidth :
                0.9 * (d.height * (a.axisX.logarithmic ? Math.log(p) / Math.log(a.axisX.range) : Math.abs(p) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0;
            this.dataPointMaxWidth && k > n && (k = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, n));
            !this.dataPointMaxWidth && (this.dataPointMinWidth && n < k) && (n = Math.max(this.dataPointWidth ? this.dataPointWidth : -Infinity, k));
            p < k && (p = k);
            p > n && (p = n);
                ...
                if (0 < q.length) {
                    ...
                    for (k = 0; k < q.length; k++)
                        if (b = q[k].x.getTime ? q[k].x.getTime() : q[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[k].y) {
                            var d = a.axisX.convertValueToPixel(b),
                                u;
                            u = 0 !== a.dataPointYSums[b] ? 100 * (q[k].y /
                                a.dataPointYSums[b]) : 0;
                            var w = d - a.plotType.plotUnits.length * p / 2 + a.index * p << 0,
                                y = w + p << 0;
                            if (a.axisY.logarithmic) {
                                h[b] = u + (h[b] ? h[b] : 0);
                                if (0 >= h[b]) continue;
                            ...
                            } else if (l = a.axisY.convertValueToPixel(u), 0 <= q[k].y) {
                                var t = f[b] ? f[b] : 0;
                                u = m + t;
                                l += t;
                                f[b] = t + (l - u)
                            ...
                            b = q[k].color ? q[k].color : r._colorSet[k % r._colorSet.length];
                            N(c, u, w, l, y, b, 0, null, s, !1, !1, !1, r.fillOpacity);
                            b = r.dataPointIds[k];
                            this._eventManager.objectMap[b] = {
                                id: b,
                                objectType: "dataPoint",
    ...
    A.prototype.renderArea = function(a) {
        function c() {
            t && (0 < n.lineThickness && b.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? y = w : 0 > a.axisY.viewportMaximum ? y = g.y1 : 0 < a.axisY.viewportMinimum && (y = f.y2), b.lineTo(q, y), b.lineTo(t.x, y), b.closePath(), b.globalAlpha = n.fillOpacity, b.fill(), b.globalAlpha = 1, v && (d.lineTo(q, y), d.lineTo(t.x,
                y), d.closePath(), d.fill()), b.beginPath(), b.moveTo(q, s), d.beginPath(), d.moveTo(q, s), t = {
                x: q,
                y: s
            })
        }
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            b.clip();
            v && (d.beginPath(), d.rect(l.x1, l.y1, l.width, l.height), d.clip());
                ...
                if (0 < p.length) {
                    ...
                    for (var J = !0; r < p.length; r++)
                        if (u = p[r].x.getTime ? p[r].x.getTime() : p[r].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !J)))
                            if ("number" !== typeof p[r].y) n.connectNullData || (J || e) || c(), J = !0;
                            else {
                                q = a.axisX.convertValueToPixel(u);
                                s = a.axisY.convertValueToPixel(p[r].y);
                                e || J ? (!e && n.connectNullData ? (b.setLineDash && (n.options.nullDataLineDashType || A === n.lineDashType && n.lineDashType !== n.nullDataLineDashType) && (b.stroke(), A = n.nullDataLineDashType,
                                    b.setLineDash(B)), b.lineTo(q, s), v && d.lineTo(q, s)) : (b.beginPath(), b.moveTo(q, s), v && (d.beginPath(), d.moveTo(q, s)), t = {
                                    x: q,
                                    y: s
                                }), J = e = !1) : (b.lineTo(q, s), v && d.lineTo(q, s), 0 == r % 250 && c());
                                r < p.length - 1 && (z !== (p[r].lineColor || x) || A !== (p[r].lineDashType || n.lineDashType)) && (c(), z = p[r].lineColor || x, b.strokeStyle = z, b.setLineDash && (p[r].lineDashType ? (A = p[r].lineDashType, b.setLineDash(I(A, n.lineThickness))) : (A = n.lineDashType, b.setLineDash(R))));
    ...
    A.prototype.renderSplineArea = function(a) {
        function c() {
            ...
            if (0 < c.length) {
                ...
                for (e = 0; e < c.length - 3; e += 3) b.bezierCurveTo(c[e + 1].x, c[e + 1].y,
                    c[e + 2].x, c[e + 2].y, c[e + 3].x, c[e + 3].y), v && d.bezierCurveTo(c[e + 1].x, c[e + 1].y, c[e + 2].x, c[e + 2].y, c[e + 3].x, c[e + 3].y);
                ...
                b.lineTo(c[c.length - 1].x, u);
                b.lineTo(w.x, u);
                b.closePath();
                b.globalAlpha = n.fillOpacity;
                b.fill();
                b.globalAlpha = 1;
                v && (d.lineTo(c[c.length - 1].x, u), d.lineTo(w.x, u), d.closePath(), d.fill())
            }
        }
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (l = 0; l < a.dataSeriesIndexes.length; l++) {
                ...
                if (0 < p.length) {
                    ...
                    for (q = !1; e < p.length; e++)
                        if (r = p[e].x.getTime ? p[e].x.getTime() : p[e].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax &&
                                (!n.connectNullData || !q)))
                            if ("number" !== typeof p[e].y) 0 < e && !q && (n.connectNullData ? b.setLineDash && (0 < y.length && (n.options.nullDataLineDashType || !p[e - 1].lineDashType)) && (y[y.length - 1].newLineDashArray = A, z = n.nullDataLineDashType) : (c(), y = [])), q = !0;
                            else {
                                ...
                                e < p.length - 1 && (x !== (p[e].lineColor ||
                                    D) || z !== (p[e].lineDashType || n.lineDashType)) && (x = p[e].lineColor || D, y[y.length - 1].newStrokeStyle = x, b.setLineDash && (p[e].lineDashType ? (z = p[e].lineDashType, y[y.length - 1].newLineDashArray = I(z, n.lineThickness)) : (z = n.lineDashType, y[y.length - 1].newLineDashArray = B)));
    ...
    A.prototype.renderStepArea = function(a) {
        function c() {
            t && (0 < n.lineThickness &&
                b.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? y = w : 0 > a.axisY.viewportMaximum ? y = g.y1 : 0 < a.axisY.viewportMinimum && (y = f.y2), b.lineTo(q, y), b.lineTo(t.x, y), b.closePath(), b.globalAlpha = n.fillOpacity, b.fill(), b.globalAlpha = 1, v && (d.lineTo(q, y), d.lineTo(t.x, y), d.closePath(), d.fill()), b.beginPath(), b.moveTo(q, s), d.beginPath(), d.moveTo(q, s), t = {
                    x: q,
                    y: s
                })
        }
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (l = 0; l < a.dataSeriesIndexes.length; l++) {
                ...
                if (0 < p.length) {
                    ...
                    var B = "solid";
                    if (b.setLineDash) {
                        var R = I(n.nullDataLineDashType, n.lineThickness),
                            B = n.lineDashType,
                    ...
                    for (; r < p.length; r++)
                        if (u = p[r].x.getTime ? p[r].x.getTime() : p[r].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !D))) {
                            ...
                            "number" !== typeof p[r].y ? (n.connectNullData ||
                                (D || e) || c(), D = !0) : (q = a.axisX.convertValueToPixel(u), s = a.axisY.convertValueToPixel(p[r].y), e || D ? (!e && n.connectNullData ? (b.setLineDash && (n.options.nullDataLineDashType || B === n.lineDashType && n.lineDashType !== n.nullDataLineDashType) && (b.stroke(), B = n.nullDataLineDashType, b.setLineDash(R)), b.lineTo(q, H), b.lineTo(q, s), v && (d.lineTo(q, H), d.lineTo(q, s))) : (b.beginPath(), b.moveTo(q, s), v && (d.beginPath(), d.moveTo(q, s)), t = {
                                x: q,
                                y: s
                            }), D = e = !1) : (b.lineTo(q, H), v && d.lineTo(q, H), b.lineTo(q, s), v && d.lineTo(q, s), 0 == r % 250 &&
                                c()), r < p.length - 1 && (A !== (p[r].lineColor || z) || B !== (p[r].lineDashType || n.lineDashType)) && (c(), A = p[r].lineColor || z, b.strokeStyle = A, b.setLineDash && (p[r].lineDashType ? (B = p[r].lineDashType, b.setLineDash(I(B, n.lineThickness))) : (B = n.lineDashType, b.setLineDash(J)))), H = n.dataPointIds[r], this._eventManager.objectMap[H] = {
                                id: H,
                                objectType: "dataPoint",
                                dataSeriesIndex: m,
                                dataPointIndex: r,
                                x1: q,
                                y1: s
                            }, 0 !== p[r].markerSize && (0 < p[r].markerSize || 0 < n.markerSize) && (u = n.getMarkerProperties(r, q, s, b), k = u.color, h.push(u), H = G(H),
                                v && h.push({
                                    x: q,
                                    y: s,
                                    ctx: d,
    ...
    A.prototype.renderStackedArea = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var d = null,
                ...
                n = [],
                p = 0,
                e, r, q, s = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                    a.axisY.viewportMinimum : 0),
                    ...
                    for (var J = !0, p = 0; p < m.length; p++) {
                        ...
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!t.connectNullData || !J)))
                            if ("number" !== typeof H.y) t.connectNullData || (J || w) || c(), J = !0;
                                ...
                                k[q] = s - r;
                                w || J ? (!w && t.connectNullData ? (b.setLineDash && (t.options.nullDataLineDashType ||
                                    A === t.lineDashType && t.lineDashType !== t.nullDataLineDashType) && (b.stroke(), A = t.nullDataLineDashType, b.setLineDash(B)), b.lineTo(e, r), v && u.lineTo(e, r)) : (b.beginPath(), b.moveTo(e, r), v && (u.beginPath(), u.moveTo(e, r))), J = w = !1) : (b.lineTo(e, r), v && u.lineTo(e, r), 0 == p % 250 && (c(), b.moveTo(e, r), v && u.moveTo(e, r), l.push({
                                    x: e,
                                    y: s - da
                                })));
                                p < D.length - 1 && (z !== (D[p].lineColor || x) || A !== (D[p].lineDashType || t.lineDashType)) && (c(), b.beginPath(), b.moveTo(e, r), l.push({
                                        x: e,
                                        y: s - da
                                    }), z = D[p].lineColor || x, b.strokeStyle = z, b.setLineDash &&
                                    (D[p].lineDashType ? (A = D[p].lineDashType, b.setLineDash(I(A, t.lineThickness))) : (A = t.lineDashType, b.setLineDash(R))));
                    ...
                    for (var J = !0, p = 0; p < m.length; p++) {
                        ...
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!t.connectNullData || !J)))
                            if ("number" !== typeof H.y) t.connectNullData || (J || w) || c(), J = !0;
                                ...
                                0 <= t.dataPointIndexes[q] && 0 !== H.markerSize && (0 < H.markerSize || 0 < t.markerSize) && (q = t.getMarkerProperties(p, e, r, b),
                                    h = q.color, g.push(q), markerColor = G(Ga), v && g.push({
                                        x: e,
                                        y: r,
                                        ctx: u,
                                        type: q.type,
    ...
    A.prototype.renderBubble = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var h = -Infinity, k = Infinity, l = 0; l < a.dataSeriesIndexes.length; l++)
                for (var m = a.dataSeriesIndexes[l], n = this.data[m], p = n.dataPoints, e = 0, d = 0; d < p.length; d++) f = p[d].getTime ? f = p[d].x.getTime() : f = p[d].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof p[d].z || (e = p[d].z, e > h && (h = e), e < k && (k = e));
            for (var r = 25 * Math.PI, b = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI, r), l = 0; l < a.dataSeriesIndexes.length; l++)
                if (m = a.dataSeriesIndexes[l], n = this.data[m], p = n.dataPoints,
                    0 < p.length)
                    for (c.strokeStyle = "#4572A7 ", d = 0; d < p.length; d++)
                        if (f = p[d].getTime ? f = p[d].x.getTime() : f = p[d].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof p[d].y) {
                            f = a.axisX.convertValueToPixel(f);
                            g = a.axisY.convertValueToPixel(p[d].y);
                            var e = p[d].z,
                                q = 2 * Math.max(Math.sqrt((h === k ? b / 2 : r + (b - r) / (h - k) * (e - k)) / Math.PI) << 0, 1),
                                e = n.getMarkerProperties(d, c);
                            e.size = q;
    ...
    A.prototype.renderScatter = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            c.rect(b.x1, b.y1, b.width, b.height);
            c.clip();
            v && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(b.x1,
                b.y1, b.width, b.height), this._eventManager.ghostCtx.clip());
                ...
                if (0 < m.length) {
                    ...
                    for (var n = 0, p = 0, d = 0; d < m.length; d++)
                        if (f = m[d].getTime ? f = m[d].x.getTime() : f = m[d].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[d].y) {
                            ...
                            var e = l.getMarkerProperties(d,
                                f, g, c);
                            c.globalAlpha = l.fillOpacity;
                            P.drawMarker(e.x, e.y, e.ctx, e.type, e.size, e.color, e.borderColor, e.borderThickness);
                            c.globalAlpha = 1;
                            Math.sqrt((n - f) * (n - f) + (p - g) * (p - g)) < Math.min(e.size, 5) && m.length > Math.min(this.plotArea.width, this.plotArea.height) || (n = l.dataPointIds[d], this._eventManager.objectMap[n] = {
                                id: n,
                                objectType: "dataPoint",
                                dataSeriesIndex: k,
                                dataPointIndex: d,
                                x1: f,
                                y1: g
                            }, n = G(n), v && P.drawMarker(e.x, e.y, this._eventManager.ghostCtx, e.type, e.size, n, n, e.borderThickness), (m[d].indexLabel || l.indexLabel ||
                                m[d].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
                                chartType: "scatter",
                                dataPoint: m[d],
                                dataSeries: l,
                                point: {
    ...
    A.prototype.renderCandlestick = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var d = null,
                d = this.plotArea,
                f = 0,
                g, h, k, l, m, n, f = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1;
            ...
            isFinite(p) || (p = 0.3 * Math.abs(a.axisX.range));
            p = this.dataPointWidth ? this.dataPointWidth : 0.7 * d.width * (a.axisX.logarithmic ? Math.log(p) / Math.log(a.axisX.range) : Math.abs(p) /
                Math.abs(a.axisX.range)) << 0;
            ...
            c.rect(d.x1, d.y1, d.width, d.height);
            c.clip();
            v && (b.beginPath(), b.rect(d.x1, d.y1, d.width, d.height), b.clip());
            for (var e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                if (0 < s.length)
                    for (var u = 5 < p && q.bevelEnabled ? !0 : !1, f = 0; f < s.length; f++)
                        if (s[f].getTime ? n = s[f].x.getTime() : n = s[f].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax) && null !== s[f].y && s[f].y.length && "number" === typeof s[f].y[0] && "number" === typeof s[f].y[1] && "number" === typeof s[f].y[2] && "number" === typeof s[f].y[3]) {
                            ...
                            var w = g - p / 2 << 0,
                                y = w + p << 0,
                                d = s[f].color ? s[f].color : q._colorSet[0],
                            ...
                            "candlestick" === q.type ? (c.moveTo(g - x, k), c.lineTo(g - x, Math.min(h, m)), c.stroke(), c.moveTo(g - x, Math.max(h, m)), c.lineTo(g - x, l), c.stroke(), N(c,
                                ...
                                k), b.lineTo(g - x, l), b.stroke(), b.beginPath(), b.moveTo(g, h), b.lineTo(w, h), b.stroke(), b.beginPath(), b.moveTo(g, m), b.lineTo(y, m), b.stroke()));
    ...
    A.prototype.renderRangeColumn = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            k = this.dataPointWidth ?
                this.dataPointWidth : 0.9 * (d.width * (a.axisX.logarithmic ? Math.log(k) / Math.log(a.axisX.range) : Math.abs(k) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0;
            this.dataPointMaxWidth && f > g && (f = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, g));
            !this.dataPointMaxWidth && (this.dataPointMinWidth && g < f) && (g = Math.max(this.dataPointWidth ? this.dataPointWidth : -Infinity, f));
            k < f && (k = f);
            k > g && (k = g);
                ...
                if (0 < p.length)
                    for (var e = 5 < k && n.bevelEnabled ? !0 : !1, f = 0; f < p.length; f++)
                        if (p[f].getTime ? h = p[f].x.getTime() : h = p[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && null !== p[f].y && p[f].y.length && "number" === typeof p[f].y[0] && "number" === typeof p[f].y[1]) {
                            b =
                                a.axisX.convertValueToPixel(h);
                            d = a.axisY.convertValueToPixel(p[f].y[0]);
                            g = a.axisY.convertValueToPixel(p[f].y[1]);
                            var r = a.axisX.reversed ? b + a.plotType.totalDataSeries * k / 2 - (a.previousDataSeriesCount + l) * k << 0 : b - a.plotType.totalDataSeries * k / 2 + (a.previousDataSeriesCount + l) * k << 0,
                            ...
                            N(c, r, d, q, g, b, 0, b, e, e, !1, !1, n.fillOpacity);
                            b = G(s);
                            v && N(this._eventManager.ghostCtx, r, d, q, g, b, 0, null, !1, !1, !1, !1);
                            if (p[f].indexLabel || n.indexLabel || p[f].indexLabelFormatter || n.indexLabelFormatter) this._indexLabels.push({
    ...
    A.prototype.renderRangeBar = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            l = this.dataPointWidth ? this.dataPointWidth : 0.9 * (d.height * (a.axisX.logarithmic ? Math.log(l) / Math.log(a.axisX.range) : Math.abs(l) / Math.abs(a.axisX.range)) /
                ...
                if (0 < e.length) {
                    ...
                    for (f = 0; f < e.length; f++)
                        if (e[f].getTime ? k = e[f].x.getTime() : k = e[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && null !== e[f].y && e[f].y.length && "number" === typeof e[f].y[0] && "number" === typeof e[f].y[1]) {
                            ...
                            N(c, d, h, g, q, b, 0, null, r, !1, !1, !1, p.fillOpacity);
                            b = p.dataPointIds[f];
                            this._eventManager.objectMap[b] = {
                                id: b,
                                objectType: "dataPoint",
                            ...
                            b = G(b);
                            v && N(this._eventManager.ghostCtx, d, h, g, q,
                                b, 0, null, !1, !1, !1, !1);
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                var f = [],
                    ...
                    r, q, s, u, w = null;
                if (0 < n.length) {
                    var y = m._colorSet[e % m._colorSet.length],
                    ...
                    for (var E = !0; e <
                        ...
                        if (u = n[e].x.getTime ? n[e].x.getTime() : n[e].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !E)))
                            if (null !== n[e].y && n[e].y.length && "number" === typeof n[e].y[0] && "number" === typeof n[e].y[1]) {
                                r = a.axisX.convertValueToPixel(u);
                                q = a.axisY.convertValueToPixel(n[e].y[0]);
                                s = a.axisY.convertValueToPixel(n[e].y[1]);
                                p || E ? (m.connectNullData && !p ? (b.setLineDash && (m.options.nullDataLineDashType || z === m.lineDashType && m.lineDashType !== m.nullDataLineDashType) && (k[k.length -
                                    1].newLineDashArray = B, z = m.nullDataLineDashType, b.setLineDash(A)), b.lineTo(r, q), v && d.lineTo(r, q), k.push({
                                    x: r,
                                    y: s
                                    ...
                                    x: r,
                                    y: s
                                }), v && (d.beginPath(), d.moveTo(r, q))), E = p = !1) : (b.lineTo(r, q), k.push({
                                    x: r,
                                    y: s
                                }), v && d.lineTo(r, q), 0 == e % 250 && c());
                                u = m.dataPointIds[e];
                                ...
                                e < n.length - 1 && (x !== (n[e].lineColor || t) || z !== (n[e].lineDashType || m.lineDashType)) && (c(),
                                    x = n[e].lineColor || t, k[k.length - 1].newStrokeStyle = x, b.strokeStyle = x, b.setLineDash && (n[e].lineDashType ? (z = n[e].lineDashType, k[k.length - 1].newLineDashArray = I(z, m.lineThickness), b.setLineDash(k[k.length - 1].newLineDashArray)) : (z = m.lineDashType, k[k.length - 1].newLineDashArray = B, b.setLineDash(B))));
        ...
        function c(a, c) {
            ...
            if (0 < e.length) {
                ...
                for (f = 0; f < e.length - 3; f += 3) b.bezierCurveTo(e[f + 1].x, e[f + 1].y, e[f + 2].x, e[f + 2].y, e[f + 3].x,
                    e[f + 3].y), v && d.bezierCurveTo(e[f + 1].x, e[f + 1].y, e[f + 2].x, e[f + 2].y, e[f + 3].x, e[f + 3].y);
                e = va(s, 2);
                b.lineTo(s[s.length - 1].x, s[s.length - 1].y);
                for (f = e.length - 1; 2 < f; f -= 3) b.bezierCurveTo(e[f - 1].x, e[f - 1].y, e[f - 2].x, e[f - 2].y, e[f - 3].x, e[f - 3].y), v && d.bezierCurveTo(e[f - 1].x, e[f - 1].y, e[f - 2].x, e[f - 2].y, e[f - 3].x, e[f - 3].y);
                b.closePath();
                b.globalAlpha = l.fillOpacity;
                b.fill();
                v && (d.closePath(), d.fill());
                b.globalAlpha = 1;
                if (0 < l.lineThickness) {
                    b.strokeStyle = c;
                    b.setLineDash && b.setLineDash(a);
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                if (0 < m.length) {
                    ...
                    for (e = !1; n < m.length; n++)
                        if (p = m[n].x.getTime ? m[n].x.getTime() : m[n].x, !(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax && (!l.connectNullData || !e)))
                            if (null !== m[n].y && m[n].y.length && "number" === typeof m[n].y[0] && "number" === typeof m[n].y[1]) {
                                ...
                                n < m.length - 1 && (y !== (m[n].lineColor || w) || t !== (m[n].lineDashType || l.lineDashType)) && (y = m[n].lineColor || w, q[q.length - 1].newStrokeStyle = y, b.setLineDash && (m[n].lineDashType ? (t = m[n].lineDashType, q[q.length - 1].newLineDashArray = I(t, l.lineThickness)) : (t = l.lineDashType, q[q.length - 1].newLineDashArray = x)));
                                if (0 !== m[n].markerSize && (0 < m[n].markerSize || 0 < l.markerSize)) {
                                    var B =
                                        l.getMarkerProperties(n, p, e, b),
                                        g = B.color;
                                    f.push(B);
                                    var E = G(A);
                                    v && f.push({
                                ...
                                e = !1
                            } else 0 < n && !e && (l.connectNullData ? b.setLineDash && (0 < q.length && (l.options.nullDataLineDashType || !m[n - 1].lineDashType)) && (q[q.length - 1].newLineDashArray = z, t = l.nullDataLineDashType) : (c(x, w), q = [], s = [])), e = !0;
                    c(x, w);
                    P.drawMarkers(f);
                    l.markerColor = g
                }
    ...
    var Ha = function(a, c, b, d, f, g, h, k, l) {
        if (!(0 > b)) {
            ...
            a.save();
            a.globalAlpha = k;
            "pie" === f ? (a.beginPath(), a.moveTo(c.x, c.y), a.arc(c.x, c.y, b, g, h, !1), a.fillStyle = d, a.strokeStyle = "white", a.lineWidth = 2, a.closePath(), a.fill()) : "doughnut" === f && (a.beginPath(), a.arc(c.x,
                c.y, b, g, h, !1), 0 <= l && a.arc(c.x, c.y, l * b, h, g, !0), a.closePath(), a.fillStyle = d, a.strokeStyle = "white", a.lineWidth = 2, a.fill());
            a.globalAlpha = 1;
            a.restore()
        }
    };
    A.prototype.renderPie = function(a) {
        function c() {
            if (m && n) {
                for (var a = 0, b = 0, c = 0, d = 0, f = 0; f < n.length; f++) {
                    ...
                    p = g.indexLabelFormatter ? g.indexLabelFormatter(q) : g.indexLabel ? l.replaceKeywordsWithValue(g.indexLabel, g, m, f) : m.indexLabelFormatter ? m.indexLabelFormatter(q) : m.indexLabel ? l.replaceKeywordsWithValue(m.indexLabel, g, m, f) : g.label ? g.label : "";
                    ...
                    k.indexLabelLineColor = g.indexLabelLineColor ? g.indexLabelLineColor :
                        m.options.indexLabelLineColor ? m.options.indexLabelLineColor : g.color ? g.color : m._colorSet[f % m._colorSet.length];
                    ...
                    k.indexLabelFontWeight =
                        g.indexLabelFontWeight ? g.indexLabelFontWeight : m.indexLabelFontWeight;
                    ...
                    k.indexLabelMaxWidth = g.indexLabelMaxWidth ? g.indexLabelMaxWidth : m.indexLabelMaxWidth ?
                        m.indexLabelMaxWidth : 0.33 * e.width;
                    ...
                    k.endAngle = k.startAngle + 2 * Math.PI / v * Math.abs(g.y);
                    ...
                    if (k.midAngle > Math.PI / 2 - w && k.midAngle < Math.PI / 2 + w) {
                        ...
                        a++
                    } else if (k.midAngle > 3 * Math.PI / 2 - w && k.midAngle <
                        3 * Math.PI / 2 + w) {
                ...
                p = !1;
                for (f = 0; f < n.length; f++) k = r[(d + f) % n.length], 1 < b && (k.midAngle > 3 * Math.PI / 2 - w && k.midAngle < 3 * Math.PI / 2 + w) && (h <= b / 2 && !p ? (k.hemisphere = "left", h++) : (k.hemisphere = "right", p = !0))
            }
        }
        ...
        function b(a) {
            ...
            for (b = 0; b < n.length; b++) {
                ...
                if (d > c) {
                    var f = 0.07 * B * Math.cos(r[b].midAngle),
                        ...
                        k = !1;
                    if (n[b].exploded) {
                        if (1E-9 < Math.abs(r[b].center.x - (t.x + f)) || 1E-9 < Math.abs(r[b].center.y - (t.y + g))) r[b].center.x = t.x + f * a, r[b].center.y = t.y + g * a, k = !0
                    } else if (0 < Math.abs(r[b].center.x - t.x) || 0 < Math.abs(r[b].center.y - t.y)) r[b].center.x = t.x + f * (1 - a), r[b].center.y = t.y + g * (1 - a), k = !0;
                    k && (f = {}, f.dataSeries = m, f.dataPoint =
                        m.dataPoints[b], f.index = b, l.toolTip.highlightObjects([f]));
            ...
            a.lineJoin = "round";
            for (b = b = 0; b < n.length; b++) c = r[b], c.indexLabelText && (c.indexLabelTextBlock.y -= c.indexLabelTextBlock.height / 2, d = 0, d = "left" === c.hemisphere ? "inside" !== m.indexLabelPlacement ? -(c.indexLabelTextBlock.width +
                ...
                c.indexLabelLineThickness)), a.beginPath(), a.moveTo(d, f), a.lineTo(c.indexLabelTextBlock.x, c.indexLabelTextBlock.y), a.lineTo(c.indexLabelTextBlock.x + ("left" === c.hemisphere ? -p : p), c.indexLabelTextBlock.y), a.stroke()), a.lineJoin = "miter");
            a.save()
        }
        ...
        function f(a) {
            for (var b = null, c = 1; c < n.length; c++)
                if (b = (a + c + r.length) % r.length, r[b].hemisphere !== r[a].hemisphere) {
                    b = null;
                    break
                } else if (r[b].indexLabelText && b !== a && (0 > d(r[b], r[a]) || ("right" === r[a].hemisphere ? r[b].indexLabelTextBlock.y >= r[a].indexLabelTextBlock.y : r[b].indexLabelTextBlock.y <= r[a].indexLabelTextBlock.y))) break;
            else b = null;
            return b
        }
            ...
            if (0 <= a && a < n.length) {
                ...
                for (l = 1; l < n.length; l++)
                    if (k = (a - l + r.length) % r.length, r[k].hemisphere !== r[a].hemisphere) {
                        k = null;
                        break
                    } else if (r[k].indexLabelText && r[k].hemisphere === r[a].hemisphere && k !== a && (0 > d(r[k], r[a]) ||
                        ("right" === r[a].hemisphere ? r[k].indexLabelTextBlock.y <= r[a].indexLabelTextBlock.y : r[k].indexLabelTextBlock.y >= r[a].indexLabelTextBlock.y))) break;
                else k = null;
                p = k;
                m = f(a);
                l = k = 0;
                0 > b ? (l = "right" === h.hemisphere ? p : m, e = b, null !== l && (p = -b, b = h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - (r[l].indexLabelTextBlock.y + r[l].indexLabelTextBlock.height / 2), b - p < q && (k = -p, l = g(l, k, c + 1), +l.toFixed(y) > +k.toFixed(y) && (e = b > q ? -(b - q) : -(p - (l - k)))))) : 0 < b && (l = "right" === h.hemisphere ? m : p, e = b, null !== l && (p = b, b = r[l].indexLabelTextBlock.y -
                    r[l].indexLabelTextBlock.height / 2 - (h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2), b - p < q && (k = p, l = g(l, k, c + 1), +l.toFixed(y) < +k.toFixed(y) && (e = b > q ? b - q : p - (k - l)))));
                e && (c = h.indexLabelTextBlock.y + e, b = 0, b = "right" === h.hemisphere ? t.x + Math.sqrt(Math.pow(s, 2) - Math.pow(c - t.y, 2)) : t.x - Math.sqrt(Math.pow(s, 2) - Math.pow(c - t.y, 2)), h.midAngle > Math.PI / 2 - w && h.midAngle < Math.PI / 2 + w ? (k = (a - 1 + r.length) % r.length, k = r[k], a = r[(a + 1 + r.length) % r.length], "left" === h.hemisphere && "right" === k.hemisphere && b > k.indexLabelTextBlock.x ?
                    ...
                    b, h.indexLabelAngle = Math.atan2(h.indexLabelTextBlock.y - t.y, h.indexLabelTextBlock.x - t.x))
            }
            return e
        }
        ...
        function h() {
            ...
            for (var b = a = 0, c = 0, k = !0, b = 0; 10 > b && (1 > b || 0 < c); b++) {
                    ...
                    for (var w, v, a = 0; a < n.length; a++) {
                        ...
                        if (null !== x) {
                            ...
                            var z = 0,
                                z = d(w, v) - q;
                            if (0 > z) {
                                for (var A = v = 0, D = 0; D < n.length; D++) D !== a && r[D].hemisphere === h.hemisphere && (r[D].indexLabelTextBlock.y < h.indexLabelTextBlock.y ? v++ : A++);
                                v = z / (v + A || 1) * A;
                                var A = -1 * (z - v),
                                    C = D = 0;
                ...
                for (a = 0; a < n.length; a++)
                    if (h = r[a], x = h.indexLabelTextBlock.measureText(), 0 !== x.height && 0 !== x.width) x = x = 0, "right" === h.hemisphere ? (x = e.x2 - (h.indexLabelTextBlock.x + h.indexLabelTextBlock.width + p), x *= -1) : x = e.x1 - (h.indexLabelTextBlock.x -
                ...
                var G = function(a, b, c) {
                    for (var d = [], e = 0; d.push(r[b]), b !== c; b = (b + 1 +
                            n.length) % n.length);
                    d.sort(function(a, b) {
                        return a.y - b.y
                    });
                ...
                (function() {
                    for (var a = -1, b = -1, c = 0, e = !1, g = 0; g < n.length; g++)
                            ...
                            if (null !== h) {
                                ...
                                if (l = 0 > z) {
                                    ...
                                    var m = w.indexLabelTextBlock.y - w.indexLabelTextBlock.height / 2,
                                        q = w.indexLabelTextBlock.y + w.indexLabelTextBlock.height /
                                        2,
                                    ...
                                    l = w.indexLabelTextBlock.x + w.indexLabelTextBlock.width < k.indexLabelTextBlock.x - p || l > t + p || m > u + p || q < s - p ? !1 : !0
                                }
                                l ? (0 > a && (a = g), h !== a && (b = h, c += -z), 0 === g % Math.max(n.length / 10, 3) && (e = !0)) : e = !0;
        ...
        function k() {
            ...
            l.title && (l.title.dockInsidePlotArea ||
                "center" === l.title.horizontalAlign && "center" === l.title.verticalAlign) && l.title.render();
            if (l.subtitles)
            ...
            if (0 !== v) {
                ...
                this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function(a) {
                    ...
                    for (b = 0; b < n.length; b++) {
                        ...
                        d > c && Ha(l.plotArea.ctx, r[b].center, r[b].radius,
                            g, m.type, c, d, m.fillOpacity, r[b].percentInnerRadius);
                        if (f) break
                    }
                    k()
                }, function() {
    ...
    W.prototype._getLineWithWidth = function(a, c, b) {
        ...
        b > c && 1 < h.length && (h = h.substr(0, h.length - 1), b = this.ctx.measureText(h).width);
        c = !0;
    ...
    na.prototype.render = function() {
        if (this.text) {
            var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart,
                ...
                k, l;
            "top" === this.verticalAlign || "bottom" === this.verticalAlign ? (null === this.maxWidth && (this.maxWidth = c.width - 4 - h * ("center" === this.horizontalAlign ? 2 : 1)), g = 0.5 * c.height - this.margin - 2, f = 0) : "center" ===
                this.verticalAlign && ("left" === this.horizontalAlign || "right" === this.horizontalAlign ? (null === this.maxWidth && (this.maxWidth = c.height - 4), g = 0.5 * c.width - this.margin - 2) : "center" === this.horizontalAlign && (null === this.maxWidth && (this.maxWidth = c.width - 4), g = 0.5 * c.height - 4));
    ...
    xa.prototype.render = function() {
        var a = this.dockInsidePlotArea ?
            ...
            g = 0,
            h = 0,
            k = this.markerMargin = this.chart.options.legend && !x(this.chart.options.legend.markerMargin) ? this.chart.options.legend.markerMargin : 0.3 * this.fontSize;
        this.height = 0;
        var l = [],
            m = [];
        "top" === this.verticalAlign || "bottom" === this.verticalAlign ? (this.orientation = "horizontal", b = this.verticalAlign, g = this.maxWidth = null !== this.maxWidth ? this.maxWidth : c.width, h = this.maxHeight = null !== this.maxHeight ? this.maxHeight : 0.5 * c.height) : "center" ===
            this.verticalAlign && (this.orientation = "vertical", b = this.horizontalAlign, g = this.maxWidth = null !== this.maxWidth ? this.maxWidth : 0.5 * c.width, h = this.maxHeight = null !== this.maxHeight ? this.maxHeight : c.height);
        for (var n = 0; n < this.dataSeries.length; n++) {
            var p = this.dataSeries[n];
            if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type) {
                var e = p.legendMarkerType = p.legendMarkerType ? p.legendMarkerType : "line" !== p.type && "stepLine" !== p.type && "spline" !== p.type && "scatter" !== p.type && "bubble" !== p.type || !p.markerType ? $.getDefaultLegendMarker(p.type) :
                    p.markerType,
                ...
                if (!(0 >= h || "undefined" === typeof h || 0 >= r || "undefined" === typeof r)) {
                    if ("horizontal" === this.orientation) {
                        ...
                        if (!p || p.width + Math.round(e.textBlock.width +
                                s + k + (0 === p.width ? 0 : this.horizontalSpacing) + ("line" === e.chartType || "spline" === e.chartType || "stepLine" === e.chartType ? 2 * 0.1 * this.lineHeight : 0)) > g) p = {
                            items: [],
                            width: 0
                        ...
                        e.textBlock.measureText(), null !== this.itemWidth && (e.textBlock.width = this.itemWidth - (s + k + ("line" === e.chartType || "spline" === e.chartType || "stepLine" === e.chartType ? 2 * 0.1 * this.lineHeight : 0))), this.height < h - this.lineHeight ? (p = {
                            items: [],
                            width: 0
                        }, m.push(p)) : (p = m[t], t = (t + 1) % m.length), this.height += e.textBlock.height;
                    e.textBlock.x = p.width;
                    e.textBlock.y = 0;
                    p.width += Math.round(e.textBlock.width + s + k + (0 === p.width ? 0 : this.horizontalSpacing) + ("line" === e.chartType || "spline" === e.chartType || "stepLine" === e.chartType ? 2 *
                        0.1 * this.lineHeight : 0));
                    p.items.push(e);
                    this.width = Math.max(p.width, this.width);
                    q = e.textBlock.width + (s + k + ("line" === e.chartType || "spline" === e.chartType || "stepLine" === e.chartType ? 2 * 0.1 * this.lineHeight : 0))
                }
            }
            this.itemWidth = q;
        ...
        "top" === this.verticalAlign ? (f = "left" === this.horizontalAlign ? c.x1 : "right" === this.horizontalAlign ? c.x2 - this.width : c.x1 + c.width / 2 - this.width / 2,
        ...
        for (n = c = 0; n < m.length; n++) {
            ...
            for (t = v = 0; t < p.items.length; t++) {
                ...
                this.ctx.clip();
                if ("line" === e.chartType || "stepLine" === e.chartType || "spline" === e.chartType) this.ctx.strokeStyle = e.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(q - 0.1 * this.lineHeight, u + this.lineHeight / 2), this.ctx.lineTo(q + 0.85 * this.lineHeight, u + this.lineHeight / 2), this.ctx.stroke(), r -= 0.1 * this.lineHeight;
                P.drawMarker(q + s / 2, u + this.lineHeight / 2, this.ctx, e.markerType, e.markerSize, e.markerColor,
                    e.markerBorderColor, e.markerBorderThickness);
                e.textBlock.x = q + k + s;
                ...
                this.ghostCtx.fillRect(r, e.textBlock.y - this.lineHeight /
                    2, e.textBlock.x + e.textBlock.width - r, e.textBlock.height);
    ...
    $.prototype.getDefaultAxisPlacement = function() {
        ...
        if ("column" === a || "line" === a || "stepLine" === a || "spline" === a || "area" === a || "stepArea" === a || "splineArea" === a || "stackedColumn" === a || "stackedLine" === a || "bubble" === a || "scatter" === a || "stackedArea" === a || "stackedColumn100" === a || "stackedLine100" === a || "stackedArea100" === a || "candlestick" ===
            a || "ohlc" === a || "rangeColumn" === a || "rangeArea" === a || "rangeSplineArea" === a) return "normal";
    ...
    $.getDefaultLegendMarker = function(a) {
        if ("column" === a || "stackedColumn" === a || "stackedLine" === a || "bar" === a || "stackedBar" === a || "stackedBar100" === a || "bubble" === a || "scatter" === a || "stackedColumn100" === a || "stackedLine100" ===
            a || "stepArea" === a || "candlestick" === a || "ohlc" === a || "rangeColumn" === a || "rangeBar" === a || "rangeArea" === a || "rangeSplineArea" === a) return "square";
        ...
        for (;;) {
            ...
            if (0 <= g && g < this.dataPoints.length) {
                var d = this.dataPoints[g],
                    p = this.axisX.logarithmic ? d.x > a ? d.x / a : a / d.x : Math.abs(d.x - a);
                p < b.distance && (b.dataPoint = d, b.distance = p, b.index = g);
                d = p;
                d <= k ? k = d : 0 < h ? l++ : m++;
    ...
    $.prototype.getDataPointAtXY = function(a, c, b) {
        if (!this.dataPoints || 0 === this.dataPoints.length || a < this.chart.plotArea.x1 || a > this.chart.plotArea.x2 ||
            c < this.chart.plotArea.y1 || c > this.chart.plotArea.y2) return null;
        b = b || !1;
        var d = [],
            f = 0,
            g = 0,
            ...
            n = 0,
            p = 0;
        "none" !== this.chart.plotInfo.axisPlacement && (p = (this.chart.axisX[0] ? this.chart.axisX[0] : this.chart.axisX2[0]).getXValueAt({
            x: a,
            y: c
        }), this.axisX.logarithmic ? (g = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x), p = 1 < g ? Math.min(Math.max((this.dataPoints.length - 1) / g * Math.log(p / this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0) : (g = this.dataPoints[this.dataPoints.length -
            1].x - this.dataPoints[0].x, p = 0 < g ? Math.min(Math.max((this.dataPoints.length - 1) / g * (p - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0));
        for (;;) {
            g = 0 < h ? p + f : p - f;
            if (0 <= g && g < this.dataPoints.length) {
                    ...
                    switch (this.type) {
                        ...
                        case "scatter":
                            var s = L("markerSize", r, this) || 4,
                                u = b ? 20 : s,
                                q = Math.sqrt(Math.pow(e.x1 - a, 2) + Math.pow(e.y1 - c, 2));
                            q <= u && d.push({
                                dataPoint: r,
                                dataPointIndex: g,
                                dataSeries: this,
                        ...
                        case "rangeSplineArea":
                            ...
                            u = b ? 20 : s;
                            q = Math.min(Math.sqrt(Math.pow(e.x1 - a, 2) + Math.pow(e.y1 - c, 2)), Math.sqrt(Math.pow(e.x1 - a, 2) + Math.pow(e.y2 - c, 2)));
                            q <= u && d.push({
                                dataPoint: r,
                                dataPointIndex: g,
                                dataSeries: this,
                        ...
                        case "doughnut":
                            ...
                            q = Math.sqrt(Math.pow(s.x - a, 2) + Math.pow(s.y - c, 2));
                            q < e.radius && q > u && (q = Math.atan2(c - s.y, a - s.x), 0 > q && (q += 2 * Math.PI), q = Number(((180 * (q / Math.PI) % 360 + 360) % 360).toFixed(12)), s = Number(((180 * (e.startAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), u = Number(((180 * (e.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), 0 === u && 1 < e.endAngle && (u = 360), s >= u && 0 !== r.y && (u += 360, q < s && (q += 360)), q > s && q < u && (d.push({
                                    dataPoint: r,
                                    dataPointIndex: g,
                                    dataSeries: this,
                                    distance: 0
                        ...
                        case "candlestick":
                            ...
                            break;
                        case "ohlc":
                            if (Math.abs(e.x2 - a + e.x1 - a) < e.borderThickness && c >= e.y2 && c <= e.y3 || a >= e.x1 && a <= (e.x2 + e.x1) / 2 && c >= e.y1 - e.borderThickness / 2 && c <= e.y1 +
                                e.borderThickness / 2 || a >= (e.x1 + e.x2) / 2 && a <= e.x2 && c >= e.y4 - e.borderThickness / 2 && c <= e.y4 + e.borderThickness / 2) d.push({
                                dataPoint: r,
                                dataPointIndex: g,
                                dataSeries: this,
                                distance: Math.min(Math.abs(e.x1 - a), Math.abs(e.x2 - a), Math.abs(e.y2 - c), Math.abs(e.y3 - c))
    ...
    B.prototype.createLabels =
        function() {
            ...
            if ("axisX" === this.type && b && !this.logarithmic)
                for (this.intervalStartPosition = this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType, this.interval), f = Ia(new Date(this.viewportMaximum), this.interval, this.intervalType), b = this.intervalStartPosition; b < f; Ia(b, k, this.intervalType)) a =
                    b.getTime(), a = this.labelFormatter ? this.labelFormatter({
                        chart: this.chart,
                        axis: this.options,
                        value: b,
                ...
                if (this.labels) {
                    ...
                    p && (this.interval = a, this.intervalStartPosition =
                        k)
                }
                ...
                for (b = this.intervalStartPosition; b <=
                    f; b = parseFloat((this.logarithmic && this.equidistantInterval ? b * Math.pow(this.logarithmBase, this.interval) : b + this.interval).toFixed(14))) a = this.labelFormatter ? this.labelFormatter({
                    chart: this.chart,
                    axis: this.options,
                    value: b,
                    label: this.labels[b] ? this.labels[b] : null
            ...
            if ("bottom" === this._position || "top" === this._position) l = this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length ? this.lineCoordinates.width *
                Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position)) / Math.log(this.range) : this.lineCoordinates.width / (this.logarithmic && this.equidistantInterval ? Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range)) * E[this.intervalType + "Duration"] * this.interval, g = "undefined" === typeof this.options.labelMaxWidth ? 0.5 * this.chart.width >> 0 : this.options.labelMaxWidth, this.chart.panEnabled || (h = "undefined" ===
                    typeof this.options.labelWrap || this.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize);
            ...
            if (this.labelAutoFit ||
                ...
                if (x(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position || "top" === this._position)
                    if (g = 0.9 * l >> 0, p = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
                        ...
                        for (b = 0; b < this._labels.length; b++) {
                            ...
                            for (var q, s = a.text.split(" "), d = 0; d < s.length; d++) e = s[d], this.ctx.font = a.fontStyle + " " + a.fontWeight + " " + a.fontSize + "px " + a.fontFamily, e = this.ctx.measureText(e), e.width > p && (q = b, p = e.width)
                        }
                        b = 0;
                        for (b = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; b < this._labels.length; b++)
                            if (a = this._labels[b].textBlock, r = a.measureText(), b < this._labels.length - 1 && (e = b + 1, c = this._labels[e].textBlock,
                                    c = c.measureText()), f.push(a.height), this.sessionVariables.labelMaxHeight = Math.max.apply(Math, f), Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)), Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), d = g * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) + (h - a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)), x(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                                if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? h : Math.min((d - g * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) /
                                    ...
                                    this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = h, this.sessionVariables.labelWrap = this.labelWrap);
                                else {
                                    if (x(this.options.labelWrap))
                                        if (!x(this.options.labelMaxWidth)) this.options.labelMaxWidth < g ? (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = d) : (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = h);
                                        else if (!x(c))
                                        if (d = r.width + c.width >> 0, e = this.labelFontSize,
                                            ...
                                            d < 5 * g ? (x(this.options.labelFontSize) && 12 < e && (e = Math.floor(12 / 13 * e), a.measureText()), this.sessionVariables.labelFontSize = x(this.options.labelFontSize) ? e : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = s) : d > 5 * g && (this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = g, this.sessionVariables.labelFontSize = e, this.sessionVariables.labelMaxHeight = h, this.sessionVariables.labelAngle = this.labelAngle));
                                        else if (q ===
                                        ...
                                        this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = s;
                                    else if (0 === k)
                                        for (this.sessionVariables.labelFontSize = x(this.options.labelFontSize) ? e : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, d = 0; d < this._labels.length; d++) a = this._labels[d].textBlock, a.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(g, p), s), r = a.measureText(), d < this._labels.length - 1 && (e = d + 1, c = this._labels[e].textBlock, c.maxWidth = this.sessionVariables.labelMaxWidth =
                                            Math.min(Math.max(g, p), s), c = c.measureText(), r.width + c.width >> 0 > 2 * g && (this.sessionVariables.labelAngle = -25))
                                }
                        else(this.sessionVariables.labelAngle = this.labelAngle, this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? h : Math.min((d - g * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), d), s = 0 != this.labelAngle ? (n - (m + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) : g, this.sessionVariables.labelMaxHeight =
                        ...
                        for (b = 0; b < this._labels.length; b++) a = this._labels[b].textBlock, a.maxWidth = this.labelMaxWidth = x(this.options.labelMaxWidth) ? this.sessionVariables.labelMaxWidth : this.options.labelMaxWidth,
                ...
                if (g = x(this.options.labelMaxWidth) ? 0.3 * this.chart.width >>
                    0 : this.options.labelMaxWidth, h = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize, !this.chart.panEnabled && 1 <= this._labels.length) {
                    this.sessionVariables.labelFontSize = this.labelFontSize;
                    this.sessionVariables.labelMaxWidth = g;
                    this.sessionVariables.labelMaxHeight = h;
            ...
            for (b = 0; b < this.stripLines.length; b++) {
                ...
                if ("outside" === g.labelPlacement) {
                    ...
                    if ("left" === this._position || "right" === this._position) u = "undefined" === typeof g.options.labelWrap ? this.sessionVariables.labelMaxHeight :
    ...
    B.setLayoutAndRender = function(a, c, b, d,
        f, g) {
        var h, k, l, m, n = a[0] ? a[0].chart : c[0].chart,
            p = n.ctx;
        if (a && 0 < a.length)
        ...
        if ("normal" === f) {
            ...
            for (; 4 > r;) {
                ...
                M.push(v);
                if (d && 0 < d.length)
                    for (t = [], e = T = 0; e < d.length; e++) t.push(Math.ceil(d[e] ?
                        d[e].createLabelsAndCalculateWidth() : 0)), T += t[e], S += d[e] ? d[e].margin : 0;
                else t.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateWidth() : 0));
                K.push(t);
                h = Math.round(g.x1 + U + C);
                l = Math.round(g.x2 - T - S > n.width - 10 ? n.width - 10 : g.x2 - T - S);
                if (a && 0 < a.length)
                    for (u = [], e = X = 0; e < a.length; e++) a[e] && (a[e].lineCoordinates = {}), a[e].lineCoordinates.width = Math.abs(l - h), a[e].title && (a[e]._titleTextBlock.maxWidth = 0 < a[e].titleMaxWidth && a[e].titleMaxWidth < a[e].lineCoordinates.width ? a[e].titleMaxWidth : a[e].lineCoordinates.width),
                        u.push(Math.ceil(a[e] ? a[e].createLabelsAndCalculateHeight() : 0)), X += u[e], f += a[e] ? a[e].margin : 0;
                else u.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateHeight() : 0));
                H.push(u);
                if (c && 0 < c.length)
                    for (w = [], e = V = 0; e < c.length; e++) c[e] && (c[e].lineCoordinates = {}), c[e].lineCoordinates.width = Math.abs(l - h), c[e].title && (c[e]._titleTextBlock.maxWidth = 0 < c[e].titleMaxWidth && c[e].titleMaxWidth < c[e].lineCoordinates.width ? c[e].titleMaxWidth : c[e].lineCoordinates.width), w.push(Math.ceil(c[e] ? c[e].createLabelsAndCalculateHeight() :
                        0)), V += w[e], L += c[e] ? c[e].margin : 0;
                else w.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
                I.push(w);
                if (a && 0 < a.length)
                    for (e = 0; e < a.length; e++) a[e] && (a[e].lineCoordinates.x1 = h, a[e].lineCoordinates.x2 = Math.round(g.x2 - T - S > n.width - 10 ? n.width - 10 : g.x2 - T - S), a[e]._labels && 1 < a[e]._labels.length && (k = m = 0, m = a[e]._labels[1], k = "dateTime" === a[e].chart.plotInfo.axisXValueType ? a[e]._labels[a[e]._labels.length - 2] : a[e]._labels[a[e]._labels.length - 1], q = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) +
                        ...
                        f + N), m = Math.round(g.y2), a[e].lineCoordinates.x2 = l, a[e].lineCoordinates.width = l - h, a[e].lineCoordinates.y1 = k, a[e].lineCoordinates.y2 = k, a[e].bounds = {
                        x1: h,
                        y1: k,
                        x2: l,
                        y2: m - (X + f - u[e] - N),
                ...
                if (c && 0 < c.length)
                    for (e = 0; e < c.length; e++) c[e].lineCoordinates.x1 = Math.round(g.x1 + U + C), c[e].lineCoordinates.x2 = Math.round(g.x2 - T - S > n.width - 10 ? n.width - 10 : g.x2 - T - S), c[e].lineCoordinates.width = Math.abs(l - h), c[e]._labels && 1 < c[e]._labels.length && (m = c[e]._labels[1], k = "dateTime" === c[e].chart.plotInfo.axisXValueType ?
                        ...
                        m = Math.round(g.y2 + c[e].margin), c[e].lineCoordinates.y1 = k + V + L - Q, c[e].lineCoordinates.y2 = k, c[e].bounds = {
                            x1: h,
                            y1: k + (V + L - w[e] - Q),
                            x2: l,
                            y2: m,
                ...
                if (b && 0 < b.length)
                    for (e = 0; e < b.length; e++) C = 10, b[e] && (h = Math.round(a[0] ? a[0].lineCoordinates.x1 : c[0].lineCoordinates.x1), C = b[e]._labels && 0 < b[e]._labels.length ? b[e]._labels[b[e]._labels.length - 1].textBlock.height / 2 : 10, k = Math.round(g.y1 + V + L < Math.max(C, 10) ? Math.max(C, 10) : g.y1 + V + L), l = Math.round(a[0] ? a[0].lineCoordinates.x1 : c[0].lineCoordinates.x1),
                        C = 0 < a.length ? 0 : b[e]._labels[0].textBlock.height / 2, m = Math.round(g.y2 - X - f - C), b[e].lineCoordinates = {
                            x1: l - P,
                            y1: k,
                            x2: l - P,
                            y2: m,
                ...
                if (d && 0 < d.length)
                    for (e = 0; e < d.length; e++) d[e] && (h = Math.round(a[0] ? a[0].lineCoordinates.x2 : c[0].lineCoordinates.x2),
                        l = Math.round(h), C = d[e]._labels && 0 < d[e]._labels.length ? d[e]._labels[d[e]._labels.length - 1].textBlock.height / 2 : 0, k = Math.round(g.y1 + V + L < Math.max(C, 10) ? Math.max(C, 10) : g.y1 + V + L), C = 0 < a.length ? 0 : d[e]._labels[0].textBlock.height / 2, m = Math.round(g.y2 - (X + f + C)), d[e].lineCoordinates = {
                            x1: h + O,
                            y1: k,
                            x2: h + O,
                            y2: m,
                            ...
                            width: l - h,
                            height: m - k
                        }, d[e].title && (d[e]._titleTextBlock.maxWidth = 0 < d[e].titleMaxWidth && d[e].titleMaxWidth < d[e].lineCoordinates.height ? d[e].titleMaxWidth :
                            d[e].lineCoordinates.height), O += t[e] + d[e].margin);
                if (a && 0 < a.length)
                ...
                if (0 < r) {
                    ...
                    if (c && 0 < c.length)
                        for (e = 0; e < c.length; e++) F = I[r - 1][e] === I[r][e] ? !0 : !1;
                    else F = !0;
                    if (b && 0 < b.length)
                        for (e = 0; e < b.length; e++) G = M[r - 1][e] === M[r][e] ? !0 : !1;
                    else G = !0;
                    if (d && 0 < d.length)
                        for (e = 0; e < d.length; e++) J = K[r - 1][e] === K[r][e] ? !0 : !1;
                    else J = !0
                }
                if (E && F && G && J) break;
                r++
            ...
            c[0] && p.rect(5, c[c.length - 1].bounds.y1, c[0].chart.width - 10, c[0].bounds.height);
            p.clip();
            if (a && 0 < a.length)
            ...
            for (; 4 > r;) {
                ...
                if (a && 0 < a.length)
                    for (B = [], e = X = 0; e < a.length; e++) B.push(Math.ceil(a[e] ? a[e].createLabelsAndCalculateWidth() :
                        0)), X += B[e], f += a[e] ? a[e].margin : 0;
                else B.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
                I.push(B);
                if (c && 0 < c.length)
                    for (q = [], e = V = 0; e < c.length; e++) q.push(Math.ceil(c[e] ? c[e].createLabelsAndCalculateWidth() : 0)), V += q[e], L += c[e] ? c[e].margin : 0;
                else q.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
                M.push(q);
                if (b && 0 < b.length)
                    for (e = 0; e < b.length; e++) b[e].lineCoordinates = {}, h = Math.round(g.x1 + X + f), l = Math.round(g.x2 - V - L > n.width - 10 ? n.width - 10 : g.x2 - V - L), b[e].labelAutoFit && !x(u) && (0 < !a.length &&
                ...
                if (d && 0 < d.length)
                    for (e = 0; e < d.length; e++) d[e].lineCoordinates = {}, h = Math.round(g.x1 + X + f), l = Math.round(g.x2 - V -
                ...
                if (b && 0 < b.length)
                    for (z = [], e = O = 0; e < b.length; e++) z.push(Math.ceil(b[e] ?
                        b[e].createLabelsAndCalculateHeight() : 0)), O += z[e] + b[e].margin, C += b[e].margin;
                else z.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateHeight() : 0));
                s.push(z);
                if (d && 0 < d.length)
                    for (A = [], e = U = 0; e < d.length; e++) A.push(Math.ceil(d[e] ? d[e].createLabelsAndCalculateHeight() : 0)), U += A[e], S += d[e].margin;
                else A.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateHeight() : 0));
                H.push(A);
                if (b && 0 < b.length)
                    for (e = 0; e < b.length; e++) 0 < b[e]._labels.length && (m = b[e]._labels[0], k = b[e]._labels[b[e]._labels.length - 1], u = m.textBlock.width *
                        Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) + (m.textBlock.height - k.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(m.textBlock.angle)), w = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - k.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)));
                if (d && 0 < d.length)
                    for (e = 0; e < d.length; e++) d[e] && 0 < d[e]._labels.length && (m = d[e]._labels[0], k = d[e]._labels[d[e]._labels.length - 1], v = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) +
                        (m.textBlock.height - k.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(m.textBlock.angle)), t = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - k.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)));
                if (n.panEnabled)
                    for (e = 0; e < b.length; e++) z[e] = n.sessionVariables.axisY.height;
                else
                    for (e = 0; e < b.length; e++) n.sessionVariables.axisY.height = z[e];
                if (b && 0 < b.length)
                    for (e = b.length - 1; 0 <= e; e--) k = Math.round(g.y2), m = Math.round(g.y2 > b[e].chart.height - 10 ?
                        b[e].chart.height - 10 : g.y2), b[e].lineCoordinates.y1 = k - (z[e] + b[e].margin + N), b[e].lineCoordinates.y2 = k - (z[e] + b[e].margin + N), b[e].bounds = {
                        x1: h,
                ...
                if (d && 0 < d.length)
                    for (e = d.length - 1; 0 <= e; e--) d[e] && (k = Math.round(g.y1), m = Math.round(g.y1 + (A[e] + d[e].margin + Q)),
                        d[e].lineCoordinates.y1 = m, d[e].lineCoordinates.y2 = m, d[e].bounds = {
                            x1: h,
                            y1: k + (d[e].margin + Q),
                            x2: l,
                            y2: m,
                ...
                if (a && 0 < a.length)
                    for (e = 0; e < a.length; e++) {
                        ...
                        h = Math.round(g.x1 + f);
                        k = d && 0 < d.length ? Math.round(d[0] ? d[0].lineCoordinates.y2 : g.y1 < Math.max(C,
                            10) ? Math.max(C, 10) : g.y1) : g.y1 < Math.max(C, 10) ? Math.max(C, 10) : g.y1;
                        ...
                        if (d && 0 < d.length)
                            for (C = 0; C < d.length; C++) d[C] && d[C].labelAutoFit &&
                                (l = d[C].lineCoordinates.x1, h = l - X);
                        a[e].lineCoordinates = {
                            x1: l - K,
                            y1: k,
                            x2: l - K,
                ...
                if (c && 0 < c.length)
                    for (e = 0; e < c.length; e++) {
                        C = c[e]._labels && 0 < c[e]._labels.length ? c[e]._labels[0].textBlock.fontSize /
                            2 : 0;
                        h = Math.round(g.x1 - f);
                        ...
                        m = b && 0 < b.length ? Math.round(b[0] ? b[0].lineCoordinates.y1 : g.y2 - O > n.height - Math.max(C, 10) ? n.height - Math.max(C, 10) : g.y2 - O) : g.y2 > n.height - Math.max(C, 10) ? n.height - Math.max(C, 10) : g.y2;
                        if (b && 0 < b.length)
                            for (C = 0; C < b.length; C++) b[C] && b[C].labelAutoFit && (l = 0 > b[C].labelAngle ? Math.max(l, u) : 0 === b[e].labelAngle ? Math.max(l, u / 2) : l, h =
                                0 > b[C].labelAngle || 0 === b[C].labelAngle ? l - V : h);
                        if (d && 0 < d.length)
                            for (C = 0; C < d.length; C++) d[C] && d[C].labelAutoFit && (l = d[C].lineCoordinates.x2, h = l - V);
                        c[e].lineCoordinates = {
                            x1: l + P,
                            y1: k,
                            x2: l + P,
                ...
                if (0 < r) {
                    ...
                    if (c && 0 < c.length)
                        for (e = 0; e < c.length; e++) F = M[r - 1][e] === M[r][e] ? !0 : !1;
                    else F = !0;
                    if (b && 0 < b.length)
                        for (e = 0; e < b.length; e++) G = s[r - 1][e] === s[r][e] ? !0 : !1;
                    else G = !0;
                    if (d && 0 < d.length)
                        for (e = 0; e < d.length; e++) J = H[r - 1][e] === H[r][e] ? !0 : !1;
                    else J = !0
                }
                if (E && F &&
                    G && J) break;
    ...
    B.prototype.renderLabelsTicksAndTitle = function() {
            ...
            if ("bottom" ===
                ...
                if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                    for (var c = [], d = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, g, h = this.viewportMaximum, k = this.lineCoordinates.width / Math.log(this.range), l = this._labels.length - 1; 0 <= l; l--) {
                        ...
                        n.position > this.viewportMaximum || !(l === this._labels.length - 1 || g < Math.log(h / n.position) * k / d) || (c.push(n), h = n.position, g = n.textBlock.width * Math.abs(Math.cos(Math.PI /
                            180 * this.labelAngle)) + n.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                    }
                    this._labels = c
                } else {
                    for (l = 0; l < this._labels.length; l++) n = this._labels[l], n.position < this.viewportMinimum || (n = n.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), c += n);
                    c > this.lineCoordinates.width * d && this.labelAutoFit && (a = !0)
                }
            if ("left" === this._position || "right" === this._position)
                if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                    for (var c = [], m, h = this.viewportMaximum, k = this.lineCoordinates.height / Math.log(this.range), l = this._labels.length - 1; 0 <= l; l--) {
                        n = this._labels[l];
                        if (n.position < this.viewportMinimum) break;
                        n.position > this.viewportMaximum || !(l === this._labels.length - 1 || m < Math.log(h / n.position) * k) || (c.push(n), h = n.position, m = n.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                    }
                    this._labels = c
                } else {
                    for (l = 0; l < this._labels.length; l++) n = this._labels[l], n.position <
        ...
        if ("bottom" === this._position) {
            for (var n, l = 0; l < this._labels.length; l++) n = this._labels[l], n.position < this.viewportMinimum || n.position > this.viewportMaximum || (b = this.getPixelCoordinatesOnAxis(n.position), a && 0 !== f++ % 2 && this.labelAutoFit || (this.tickThickness && (this.ctx.lineWidth = this.tickThickness,
            ...
            for (l = 0; l < this._labels.length; l++) n = this._labels[l], n.position < this.viewportMinimum || n.position > this.viewportMaximum || (b = this.getPixelCoordinatesOnAxis(n.position),
                a && 0 !== f++ % 2 && this.labelAutoFit || (this.tickThickness && (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor, d = 1 === this.ctx.lineWidth % 2 ? (b.x << 0) + 0.5 : b.x << 0, this.ctx.beginPath(), this.ctx.moveTo(d, b.y << 0), this.ctx.lineTo(d, b.y - this.tickLength << 0), this.ctx.stroke()), 0 === n.textBlock.angle ? (b.x -= n.textBlock.width / 2, b.y -= this.tickLength + n.textBlock.height / 2) : (b.x += (n.textBlock.height - this.tickLength - this.labelFontSize / 2) * Math.sin(Math.PI / 180 * this.labelAngle) - (0 < this.labelAngle ? n.textBlock.width *
                    Math.cos(Math.PI / 180 * this.labelAngle) : 0), b.y -= this.tickLength + (n.textBlock.height / 2 * Math.cos(Math.PI / 180 * this.labelAngle) + (0 < this.labelAngle ? n.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) : 0))), n.textBlock.x = b.x, n.textBlock.y = b.y, n.textBlock.render(!0)));
            ...
            for (l = 0; l < this._labels.length; l++) n = this._labels[l], n.position < this.viewportMinimum || n.position > this.viewportMaximum || (b = this.getPixelCoordinatesOnAxis(n.position), a && 0 !== f++ % 2 && this.labelAutoFit ||
                (this.tickThickness && (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor, d = 1 === this.ctx.lineWidth % 2 ? (b.y << 0) + 0.5 : b.y << 0, this.ctx.beginPath(), this.ctx.moveTo(b.x << 0, d), this.ctx.lineTo(b.x + this.tickLength << 0, d), this.ctx.stroke()), 0 === this.labelAngle ? (n.textBlock.y = b.y, n.textBlock.x = b.x + this.tickLength + 5) : (n.textBlock.y = 0 > this.labelAngle ? b.y : b.y - (n.textBlock.height - n.textBlock.fontSize / 2 - 5) * Math.cos(Math.PI / 180 * this.labelAngle), n.textBlock.x = 0 < this.labelAngle ? b.x + (n.textBlock.height -
                    n.textBlock.fontSize / 2 - 5) * Math.sin(Math.PI / 180 * this.labelAngle) + this.tickLength : b.x + this.tickLength + 5), n.textBlock.render(!0)));
    ...
    B.prototype.renderStripLinesOfThicknessType = function(a) {
        if (this.stripLines && 0 < this.stripLines.length && a) {
            for (var c = this, b, d = 0, f = 0, g = !1, h = !1, k = [], l = [],
                    h = !1, d = 0; d < this.stripLines.length; d++) {
                var m = this.stripLines[d];
                m._thicknessType === a && ("pixel" === a && (m.value < this.viewportMinimum || m.value > this.viewportMaximum || x(m.value) || isNaN(this.range)) || k.push(m))
            }
            ...
            if (!h) {
                ...
                for (d = 0; d < l.length; d++) b = l[d], b.stripLine.showOnTop ? h || (h = !0, this.chart.addEventListener("dataAnimationIterationEnd", function() {
            ...
            if (h)
                for (h = !1, d = 0; d < l.length; d++) b = l[d], b.stripLine.showOnTop ? h || (h = !0, this.chart.addEventListener("dataAnimationIterationEnd", function() {
    ...
    B.prototype.renderAxisLine = function() {
        ...
        if ("bottom" === this._position || "top" === this._position) {
            if (this.lineThickness) {
                ...
                a.setLineDash && a.setLineDash(I(this.lineDashType, this.lineThickness));
        ...
        } else "left" !== this._position && "right" !== this._position || !this.lineThickness || (a.lineWidth = this.lineThickness, a.strokeStyle = this.lineColor, a.setLineDash && a.setLineDash(I(this.lineDashType,
    ...
    B.prototype.calculateAxisParameters = function() {
        if (this.logarithmic) this.calculateLogarithamicAxisParameters();
            ...
            if ("axisX" === this.type) {
                ...
                Infinity !== this.dataInfo.minDiff ? h = this.dataInfo.minDiff : 1 < g - f ? h = 0.5 * Math.abs(g - f) : (h = 1, b && (c = !0))
            ...
            if ("axisX" === this.type && b) {
                this.intervalType || (d / 1 <= a ? (this.interval = 1, this.intervalType = "millisecond") : d / 2 <= a ? (this.interval = 2, this.intervalType = "millisecond") : d / 5 <= a ? (this.interval = 5, this.intervalType = "millisecond") : d / 10 <= a ? (this.interval = 10,
                    ...
                    a ? 2 : d / (4 * E.yearDuration) <= a ? 4 : Math.floor(B.getNiceNumber(d / (a - 1), !0) / E.yearDuration), this.intervalType = "year"));
                ...
                c ? this.autoValueFormatString = "MMM DD YYYY HH:mm" : "year" === this.intervalType ? this.autoValueFormatString = "YYYY" : "month" === this.intervalType ? this.autoValueFormatString = "MMM YYYY" : "week" === this.intervalType ? this.autoValueFormatString =
                ...
                this.interval =
                    this.options && 0 < this.options.interval ? this.options.interval : B.getNiceNumber(d / (a - 1), !0);
                ...
                0 === this.viewportMaximum && 0 === this.viewportMinimum && (0 === this.options.viewportMinimum ? this.viewportMaximum += 10 : 0 === this.options.viewportMaximum &&
                    (this.viewportMinimum -= 10), this.options && "undefined" === typeof this.options.interval && (this.interval = B.getNiceNumber((this.viewportMaximum - this.viewportMinimum) / (a - 1), !0)))
            }
            if (null === this.minimum || null === this.maximum)
                if ("axisX" === this.type ? (f = null !== this.minimum ? this.minimum : this.dataInfo.min, g = null !== this.maximum ? this.maximum : this.dataInfo.max, 0 === g - f && (d = "undefined" === typeof this.options.interval ? 0.4 : this.options.interval, g += d, f -= d), h = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < g - f ?
    ...
    B.prototype.calculateLogarithamicAxisParameters = function() {
        ...
        this.intervalType =
            "number";
        h = Math.pow(this.logarithmBase, B.getNiceNumber(Math.abs(Math.log(h) / c), !1));
        this.options && 0 < this.options.interval ? this.interval = this.options.interval : (this.interval = B.getNiceExponent(Math.log(h) / c / (a - 1), !0), b = B.getNiceNumber(linearRange / (a - 1), !0));
    ...
    oa.prototype.createUserOptions = function(a) {
        if ("undefined" !== typeof a || this.options._isPlaceholder) {
            ...
            this.options._isPlaceholder || (ra(this.parent.stripLines), c = this.parent.options.stripLines.indexOf(this.options));
            this.options =
    ...
    oa.prototype.render = function() {
        ...
        if (0 < c) {
            ...
            this.ctx.setLineDash &&
                this.ctx.setLineDash(I(this.lineDashType, c));
            ...
            if ((f = this.chart._eventManager.objectMap[f.dataSeries.dataPointIds[f.index]]) && f.objectType && "dataPoint" === f.objectType) {
                ...
                !1 === g.highlightEnabled || !0 !== d.highlightEnabled && !0 !== g.highlightEnabled || ("line" === d.type || "stepLine" ===
                    ...
                    "rangeColumn" === d.type ? N(c, f.x1, f.y1, f.x2, f.y2, "white", 0, null, !1, !1, !1, !1, 0.3) : "pie" === d.type || "doughnut" === d.type ? Ha(c, f.center, f.radius, "white", d.type, f.startAngle, f.endAngle, 0.3, f.percentInnerRadius) : "candlestick" === d.type ? (c.globalAlpha = 1, c.strokeStyle = f.color, c.lineWidth = 2 * f.borderThickness, d = 0 === c.lineWidth % 2 ? 0 : 0.5, c.beginPath(), c.moveTo(f.x3 - d, Math.min(f.y2, f.y3)), c.lineTo(f.x3 - d, Math.min(f.y1, f.y4)), c.stroke(), c.beginPath(), c.moveTo(f.x3 - d, Math.max(f.y1, f.y4)), c.lineTo(f.x3 - d, Math.max(f.y2,
                        f.y3)), c.stroke(), N(c, f.x1, Math.min(f.y1, f.y4), f.x2, Math.max(f.y1, f.y4), "transparent", 2 * f.borderThickness, f.color, !1, !1, !1, !1), c.globalAlpha = 1) : "ohlc" === d.type && (c.globalAlpha = 1, c.strokeStyle = f.color, c.lineWidth = 2 * f.borderThickness, d = 0 === c.lineWidth % 2 ? 0 : 0.5, c.beginPath(), c.moveTo(f.x3 - d, f.y2), c.lineTo(f.x3 - d, f.y3), c.stroke(), c.beginPath(), c.moveTo(f.x3, f.y1), c.lineTo(f.x1, f.y1), c.stroke(), c.beginPath(), c.moveTo(f.x3, f.y4), c.lineTo(f.x2, f.y4), c.stroke(), c.globalAlpha = 1))
            }
        }
        c.restore();
        c.globalAlpha =
            ...
            for (var l = null, m = "", k = 0; k < a.length; k++)
                if (b =
                    ...
                    if ("line" ===
                        ...
                        this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.options.fontColor ? "" : "'color:{color};'") + "\"'>{name}:</span>&nbsp;&nbsp;{y}", l = b.axisXIndex;
                    else if ("bubble" === b.type) this.chart.axisX && 1 < this.chart.axisX.length && (g += l != b.axisXIndex ? b.axisX.title ? b.axisX.title + "<br/>" : "X:{axisXIndex}<br/>" : ""), g += d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.options.fontColor ?
    ...
    S.prototype.show = function(a, c, b) {
    ...
    ma.prototype.fireEvent = function(a, c, b) {
        if (a && c) {
    ...
    var F = {
            yScaleAnimation: function(a, c) {
                if (0 !== a) {
                    ...
                    b.drawImage(d, 0, 0, d.width,
                        d.height, 0, f - f * a, b.canvas.width / Q, a * b.canvas.height / Q)
                }
            },
            ...
            fadeInAnimation: function(a, c) {
                if (0 !== a) {
                    ...
                    b.globalAlpha = a;
                    b.drawImage(d,
                        0, 0, d.width, d.height, 0, 0, b.canvas.width / Q, b.canvas.height / Q);
                    b.restore()
                }
            },
            easing: {
            ...
            drawMarker: function(a, c, b, d, f, g, h, k) {
                if (b) {
                    ...
                    "circle" === d ? (b.moveTo(a, c),
                        ...
                        b.strokeStyle = "black", b.stroke(), b.globalAlpha = l)), b.beginPath()) : "cross" === d && (b.strokeStyle = g, b.lineWidth = f / 4, b.beginPath(), b.moveTo(a - f / 2, c - f / 2), b.lineTo(a + f / 2, c + f / 2), b.stroke(), b.moveTo(a + f / 2, c - f / 2), b.lineTo(a - f / 2, c + f / 2), b.stroke())
                }
            },
        ...
        ka = {
            ...
            formatNumber: function(a, c, b) {
                b =
                    b || "en";
                if (qa[b]) return ca(a, c || "#,##0.##", new pa(b));
                throw "Unknown Culture Name";
            },
            formatDate: function(a, c, b) {
                b = b || "en";
                if (qa[b]) return Fa(a, c || "DD MMM YYYY", new pa(b));
                throw "Unknown Culture Name";
            }
        };
    ka.Chart.version = "v2.0.0";
    window.CanvasJS = ka
})();
/*
